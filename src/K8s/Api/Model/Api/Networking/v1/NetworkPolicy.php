 ...
 * @Kubernetes\Operation("delete",path="/apis/networking.k8s.io/v1/namespaces/{namespace}/networkpolicies/{name}",body="model",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
