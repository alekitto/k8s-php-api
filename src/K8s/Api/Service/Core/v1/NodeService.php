...
class NodeService
{
     ...
     */
    public function connectGetProxy(string $name, $handler, array $query = []): void
    {
        $options['query'] = $query;
        $options['handler'] = $handler;
        $uri = $this->api->makeUri(
     ...
     * @param callable|object $handler
     */
    public function connectDeleteProxy(string $name, $handler, array $query = []): void
    {
        $options['query'] = $query;
        $options['handler'] = $handler;
        $uri = $this->api->makeUri(
     ...
     * @param callable|object $handler
     */
    public function connectPostProxy(string $name, $handler, array $query = []): void
    {
        $options['query'] = $query;
        $options['handler'] = $handler;
        $uri = $this->api->makeUri(
     ...
     * @param callable|object $handler
     */
    public function connectPatchProxy(string $name, $handler, array $query = []): void
    {
        $options['query'] = $query;
        $options['handler'] = $handler;
        $uri = $this->api->makeUri(
     ...
     * @param callable|object $handler
     */
    public function connectPutProxy(string $name, $handler, array $query = []): void
    {
        $options['query'] = $query;
        $options['handler'] = $handler;
        $uri = $this->api->makeUri(
     ...
     * @param callable|object $handler
     */
    public function connectOptionsProxy(string $name, $handler, array $query = []): void
    {
        $options['query'] = $query;
        $options['handler'] = $handler;
        $uri = $this->api->makeUri(
     ...
     * @param callable|object $handler
     */
    public function connectHeadProxy(string $name, $handler, array $query = []): void
    {
        $options['query'] = $query;
        $options['handler'] = $handler;
        $uri = $this->api->makeUri(
     ...
     * @param callable|object $handler
     */
    public function connectGetProxyWithPath(string $name, string $path, $handler, array $query = []): void
    {
        $options['query'] = $query;
        $options['handler'] = $handler;
        $uri = $this->api->makeUri(
     ...
     * @param callable|object $handler
     */
    public function connectDeleteProxyWithPath(string $name, string $path, $handler, array $query = []): void
    {
        $options['query'] = $query;
        $options['handler'] = $handler;
        $uri = $this->api->makeUri(
     ...
     * @param callable|object $handler
     */
    public function connectPostProxyWithPath(string $name, string $path, $handler, array $query = []): void
    {
        $options['query'] = $query;
        $options['handler'] = $handler;
        $uri = $this->api->makeUri(
     ...
     * @param callable|object $handler
     */
    public function connectPatchProxyWithPath(string $name, string $path, $handler, array $query = []): void
    {
        $options['query'] = $query;
        $options['handler'] = $handler;
        $uri = $this->api->makeUri(
     ...
     * @param callable|object $handler
     */
    public function connectPutProxyWithPath(string $name, string $path, $handler, array $query = []): void
    {
        $options['query'] = $query;
        $options['handler'] = $handler;
        $uri = $this->api->makeUri(
     ...
     * @param callable|object $handler
     */
    public function connectOptionsProxyWithPath(string $name, string $path, $handler, array $query = []): void
    {
        $options['query'] = $query;
        $options['handler'] = $handler;
        $uri = $this->api->makeUri(
     ...
     * @param callable|object $handler
     */
    public function connectHeadProxyWithPath(string $name, string $path, $handler, array $query = []): void
    {
        $options['query'] = $query;
        $options['handler'] = $handler;
        $uri = $this->api->makeUri(
