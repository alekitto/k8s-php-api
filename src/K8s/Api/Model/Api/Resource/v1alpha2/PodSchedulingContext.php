 ...
 * @Kubernetes\Operation("get",path="/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/podschedulingcontexts/{name}",response="static::class")
 * @Kubernetes\Operation("get-status",path="/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/podschedulingcontexts/{name}/status",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/podschedulingcontexts",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/podschedulingcontexts/{name}",response="static::class")
 * @Kubernetes\Operation("watch",path="/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/podschedulingcontexts",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("put",path="/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/podschedulingcontexts/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("put-status",path="/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/podschedulingcontexts/{name}/status",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection",path="/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/podschedulingcontexts",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/resource.k8s.io/v1alpha2/podschedulingcontexts",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/podschedulingcontexts/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/podschedulingcontexts/{name}/status",body="patch",response="static::class")
 * @Kubernetes\Operation("list",path="/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/podschedulingcontexts",response="K8s\Api\Model\Api\Resource\v1alpha2\PodSchedulingContextList")
 * @Kubernetes\Operation("list-all",path="/apis/resource.k8s.io/v1alpha2/podschedulingcontexts",response="K8s\Api\Model\Api\Resource\v1alpha2\PodSchedulingContextList")
 */
class PodSchedulingContext
{
     ...
     * @var string
     */
    protected $kind = 'PodSchedulingContext';
    ...
    /**
     * @Kubernetes\Attribute("spec",type="model",model=PodSchedulingContextSpec::class,isRequired=true)
     * @var PodSchedulingContextSpec
     */
    protected $spec;

    /**
     * @Kubernetes\Attribute("status",type="model",model=PodSchedulingContextStatus::class)
     * @var PodSchedulingContextStatus|null
     */
    protected $status = null;

    /**
     * @param PodSchedulingContextSpec $spec
     */
    public function __construct(?string $name, PodSchedulingContextSpec $spec)
    {
    ...
    {
        return $this->status->getResourceClaims();
    }
     ...
     * @return static
     */
    public function setSpec(PodSchedulingContextSpec $spec)
    {
        $this->spec = $spec;
     ...
     */
    public function getStatus(): ?PodSchedulingContextStatus
    {
        return $this->status;
    }
     ...
     * @return static
     */
    public function setStatus(PodSchedulingContextStatus $status)
    {
        $this->status = $status;
