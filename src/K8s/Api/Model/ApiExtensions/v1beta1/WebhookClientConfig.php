...
/**
 * WebhookClientConfig contains the information to make a TLS connection with the webhook. It has the
 * same field as admissionregistration.v1beta1.WebhookClientConfig.
 */
