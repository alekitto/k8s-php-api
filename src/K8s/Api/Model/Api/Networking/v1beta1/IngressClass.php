 ...
 *
 * @Kubernetes\Kind("IngressClass",group="networking.k8s.io",version="v1beta1")
 * @Kubernetes\Operation("get",path="/apis/networking.k8s.io/v1beta1/ingressclasses/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/networking.k8s.io/v1beta1/ingressclasses",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/networking.k8s.io/v1beta1/ingressclasses/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("put",path="/apis/networking.k8s.io/v1beta1/ingressclasses/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection-all",path="/apis/networking.k8s.io/v1beta1/ingressclasses",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/networking.k8s.io/v1beta1/ingressclasses",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/networking.k8s.io/v1beta1/ingressclasses/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("list-all",path="/apis/networking.k8s.io/v1beta1/ingressclasses",response="K8s\Api\Model\Api\Networking\v1beta1\IngressClassList")
 */
class IngressClass
{
    /**
