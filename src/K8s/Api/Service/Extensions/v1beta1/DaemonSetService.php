...
class DaemonSetService
{
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#list-daemonset-v1beta1-extensions
     */
     ...
     * @param array $query
     * @param callable|null $handler
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#delete-collection-daemonset-v1beta1-extensions
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#create-daemonset-v1beta1-extensions
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#read-daemonset-v1beta1-extensions
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#delete-daemonset-v1beta1-extensions
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#patch-daemonset-v1beta1-extensions
     */
    public function patchNamespaced(string $name, array $patch, array $query = []): DaemonSet
    {
        $options['query'] = $query;
        $options['body'] = $patch;
        $options['model'] = DaemonSet::class;
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#put-daemonset-v1beta1-extensions
     */
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#patch-daemonset-v1beta1-extensions
     */
    public function patchNamespacedStatus(string $name, array $patch, array $query = []): DaemonSet
    {
        $options['query'] = $query;
        $options['body'] = $patch;
        $options['model'] = DaemonSet::class;
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#watchlist-daemonset-v1beta1-extensions
     */
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#watch-daemonset-v1beta1-extensions
     */
