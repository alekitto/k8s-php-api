 ...
 * @Kubernetes\Operation("delete",path="/apis/rbac.authorization.k8s.io/v1alpha1/clusterrolebindings/{name}",body="model",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
