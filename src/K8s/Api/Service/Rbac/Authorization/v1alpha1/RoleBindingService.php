...
class RoleBindingService
{
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.22/#list-rolebinding-v1alpha1-rbac-authorization-k8s-io
     */
    public function listRbacAuthorizationV1alpha1Namespaced(array $query = [], $handler = null): ?RoleBindingList
    {
        $options['query'] = $query;
        $options['method'] = 'get';
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.22/#delete-collection-rolebinding-v1alpha1-rbac-authorization-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.22/#create-rolebinding-v1alpha1-rbac-authorization-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.22/#read-rolebinding-v1alpha1-rbac-authorization-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.22/#delete-rolebinding-v1alpha1-rbac-authorization-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.22/#patch-rolebinding-v1alpha1-rbac-authorization-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.22/#put-rolebinding-v1alpha1-rbac-authorization-k8s-io
     */
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.22/#list-rolebinding-v1alpha1-rbac-authorization-k8s-io
     */
    public function listRbacAuthorizationV1alpha1ForAllNamespaces(array $query = [], $handler = null): ?RoleBindingList
    {
        $options['query'] = $query;
        $options['method'] = 'get';
        $options['handler'] = $handler;
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.22/#watchlist-rolebinding-v1alpha1-rbac-authorization-k8s-io
     */
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.22/#watch-rolebinding-v1alpha1-rbac-authorization-k8s-io
     */
