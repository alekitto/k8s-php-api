...
class PriorityLevelConfigurationService
{
     ...
     */
    public function listFlowControlApiServerV1alpha1(array $query = [], $handler = null): ?PriorityLevelConfigurationList
    {
        $options['query'] = $query;
        $options['method'] = 'get';
     ...
     */
    public function deleteFlowControlApiServerV1alpha1Collection(array $query = [], $handler = null): ?Status
    {
        $options['query'] = $query;
     ...
     */
    public function watchFlowControlApiServerV1alpha1List(array $query = [], $handler = null): void
    {
        $options['query'] = $query;
        $options['method'] = 'get';
        $options['handler'] = $handler;
     ...
     */
    public function watchFlowControlApiServerV1alpha1(string $name, array $query = [], $handler = null): void
    {
        $options['query'] = $query;
        $options['method'] = 'get';
        $options['handler'] = $handler;
