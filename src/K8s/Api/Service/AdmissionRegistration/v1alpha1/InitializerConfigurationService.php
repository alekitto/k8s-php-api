...
class InitializerConfigurationService
{
     ...
     */
    public function listAdmissionRegistrationV1alpha1(array $query = [], $handler = null): ?InitializerConfigurationList
    {
        $options['query'] = $query;
        $options['method'] = 'get';
     ...
     * @param callable|object|null $handler
     */
    public function deleteAdmissionRegistrationV1alpha1Collection(array $query = [], $handler = null): ?Status
    {
        $options['query'] = $query;
