 ...
 * @Kubernetes\Operation("delete",path="/apis/settings.k8s.io/v1alpha1/namespaces/{namespace}/podpresets/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
