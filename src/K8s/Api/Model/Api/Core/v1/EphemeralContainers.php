 ...
 *
 * @Kubernetes\Kind("EphemeralContainers",version="v1")
 */
class EphemeralContainers
{
    ...
    /**
     * @Kubernetes\Attribute("ephemeralContainers",type="collection",model=EphemeralContainer::class,isRequired=true)
     * @var iterable|EphemeralContainer[]
     */
     ...
     * @var string|null
     */
    protected $kind = 'EphemeralContainers';
    ...
    /**
     * @param iterable|EphemeralContainer[] $ephemeralContainers
     */
    public function __construct(?string $name, iterable $ephemeralContainers)
    {
        $this->metadata = new ObjectMeta($name);
        $this->ephemeralContainers = new Collection($ephemeralContainers);
    }
    ...
    /**
     * A list of ephemeral containers associated with this pod. New ephemeral containers may be appended to
     * this list, but existing ephemeral containers may not be removed or modified.
     *
