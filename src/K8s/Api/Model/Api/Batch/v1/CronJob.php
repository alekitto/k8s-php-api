 ...
 * @Kubernetes\Operation("deletecollection-all",path="/apis/batch/v1/namespaces/{namespace}/cronjobs",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("patch",path="/apis/batch/v1/namespaces/{namespace}/cronjobs/{name}",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/apis/batch/v1/namespaces/{namespace}/cronjobs/{name}/status",response="static::class")
