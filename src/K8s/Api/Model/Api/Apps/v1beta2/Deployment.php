...
/**
 * DEPRECATED - This group version of Deployment is deprecated by apps/v1/Deployment. See the release
 * notes for more information. Deployment enables declarative updates for Pods and ReplicaSets.
 *
 * @Kubernetes\Kind("Deployment",group="apps",version="v1beta2")
 * @Kubernetes\Operation("get",path="/apis/apps/v1beta2/namespaces/{namespace}/deployments/{name}",response="static::class")
 * @Kubernetes\Operation("get-status",path="/apis/apps/v1beta2/namespaces/{namespace}/deployments/{name}/status",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/apps/v1beta2/namespaces/{namespace}/deployments",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/apps/v1beta2/namespaces/{namespace}/deployments/{name}",body="model",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch",path="/apis/apps/v1beta2/namespaces/{namespace}/deployments",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("put",path="/apis/apps/v1beta2/namespaces/{namespace}/deployments/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("put-status",path="/apis/apps/v1beta2/namespaces/{namespace}/deployments/{name}/status",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection",path="/apis/apps/v1beta2/namespaces/{namespace}/deployments",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/apps/v1beta2/deployments",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/apps/v1beta2/namespaces/{namespace}/deployments/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/apis/apps/v1beta2/namespaces/{namespace}/deployments/{name}/status",body="patch",response="static::class")
 * @Kubernetes\Operation("list",path="/apis/apps/v1beta2/namespaces/{namespace}/deployments",response="K8s\Api\Model\Api\Apps\v1beta2\DeploymentList")
 * @Kubernetes\Operation("list-all",path="/apis/apps/v1beta2/deployments",response="K8s\Api\Model\Api\Apps\v1beta2\DeploymentList")
 */
class Deployment
{
    /**
