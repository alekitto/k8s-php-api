 ...
 * @Kubernetes\Operation("delete",path="/apis/admissionregistration.k8s.io/v1beta1/mutatingwebhookconfigurations/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
