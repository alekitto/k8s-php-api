 ...
 *
 * @Kubernetes\Kind("ResourceClaimTemplate",group="resource.k8s.io",version="v1alpha1")
 * @Kubernetes\Operation("get",path="/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/resourceclaimtemplates/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/resourceclaimtemplates",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/resourceclaimtemplates/{name}",response="static::class")
 * @Kubernetes\Operation("watch",path="/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/resourceclaimtemplates",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("put",path="/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/resourceclaimtemplates/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection",path="/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/resourceclaimtemplates",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/resource.k8s.io/v1alpha1/resourceclaimtemplates",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/resourceclaimtemplates/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("list",path="/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/resourceclaimtemplates",response="K8s\Api\Model\Api\Resource\v1alpha1\ResourceClaimTemplateList")
 * @Kubernetes\Operation("list-all",path="/apis/resource.k8s.io/v1alpha1/resourceclaimtemplates",response="K8s\Api\Model\Api\Resource\v1alpha1\ResourceClaimTemplateList")
 */
class ResourceClaimTemplate
{
     ...
     * @var string
     */
    protected $kind = 'ResourceClaimTemplate';
    ...
    /**
     * @Kubernetes\Attribute("spec",type="model",model=ResourceClaimTemplateSpec::class,isRequired=true)
     ...
     * @return static
     */
    public function setSpec(ResourceClaimTemplateSpec $spec)
    {
        $this->spec = $spec;
