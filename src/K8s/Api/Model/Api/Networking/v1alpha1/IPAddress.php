 ...
 * @Kubernetes\Operation("get",path="/apis/networking.k8s.io/v1alpha1/ipaddresses/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/networking.k8s.io/v1alpha1/ipaddresses",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/networking.k8s.io/v1alpha1/ipaddresses/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("put",path="/apis/networking.k8s.io/v1alpha1/ipaddresses/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection-all",path="/apis/networking.k8s.io/v1alpha1/ipaddresses",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("patch",path="/apis/networking.k8s.io/v1alpha1/ipaddresses/{name}",response="static::class")
 * @Kubernetes\Operation("list-all",path="/apis/networking.k8s.io/v1alpha1/ipaddresses",response="K8s\Api\Model\Api\Networking\v1alpha1\IPAddressList")
 */
class IPAddress
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("spec",type="model",model=IPAddressSpec::class)
     * @var IPAddressSpec
     */
    protected $spec;
     ...
     */
    public function __construct(?string $name, ParentReference $parentRef)
    {
     ...
     * @return static
     */
    public function setSpec(IPAddressSpec $spec)
    {
        $this->spec = $spec;
