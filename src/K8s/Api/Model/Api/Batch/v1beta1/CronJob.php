 ...
 *
 * @Kubernetes\Kind("CronJob",group="batch",version="v1beta1")
 * @Kubernetes\Operation("get",path="/apis/batch/v1beta1/namespaces/{namespace}/cronjobs/{name}",response="static::class")
 * @Kubernetes\Operation("get-status",path="/apis/batch/v1beta1/namespaces/{namespace}/cronjobs/{name}/status",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/batch/v1beta1/namespaces/{namespace}/cronjobs",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/batch/v1beta1/namespaces/{namespace}/cronjobs/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch",path="/apis/batch/v1beta1/namespaces/{namespace}/cronjobs",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("put",path="/apis/batch/v1beta1/namespaces/{namespace}/cronjobs/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("put-status",path="/apis/batch/v1beta1/namespaces/{namespace}/cronjobs/{name}/status",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection",path="/apis/batch/v1beta1/namespaces/{namespace}/cronjobs",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/batch/v1beta1/cronjobs",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/batch/v1beta1/namespaces/{namespace}/cronjobs/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/apis/batch/v1beta1/namespaces/{namespace}/cronjobs/{name}/status",body="patch",response="static::class")
 * @Kubernetes\Operation("list",path="/apis/batch/v1beta1/namespaces/{namespace}/cronjobs",response="K8s\Api\Model\Api\Batch\v1beta1\CronJobList")
 * @Kubernetes\Operation("list-all",path="/apis/batch/v1beta1/cronjobs",response="K8s\Api\Model\Api\Batch\v1beta1\CronJobList")
 */
class CronJob
{
    /**
     ...
     * https://en.wikipedia.org/wiki/List_of_tz_database_time_zones. If not specified, this will rely on
     * the time zone of the kube-controller-manager process. ALPHA: This field is in alpha and must be
     * enabled via the `CronJobTimeZone` feature gate.
     */
