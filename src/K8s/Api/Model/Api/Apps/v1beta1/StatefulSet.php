 ...
 * @Kubernetes\Operation("get-status",path="/apis/apps/v1beta1/namespaces/{namespace}/statefulsets/{name}/status",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/apps/v1beta1/namespaces/{namespace}/statefulsets",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/apps/v1beta1/namespaces/{namespace}/statefulsets/{name}",body="model",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 ...
 * @Kubernetes\Operation("patch-status",path="/apis/apps/v1beta1/namespaces/{namespace}/statefulsets/{name}/status",body="patch",response="static::class")
