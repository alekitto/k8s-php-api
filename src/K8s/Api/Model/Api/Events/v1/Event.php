 ...
 * @Kubernetes\Operation("deletecollection-all",path="/apis/events.k8s.io/v1/namespaces/{namespace}/events",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("patch",path="/apis/events.k8s.io/v1/namespaces/{namespace}/events/{name}",response="static::class")
