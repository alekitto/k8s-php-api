 ...
 * notes for more information. CSINode holds information about all CSI drivers installed on a node. CSI
 * drivers do not need to create the CSINode object directly. As long as they use the
 * node-driver-registrar sidecar container, the kubelet will automatically populate the CSINode object
 * for the CSI driver as part of kubelet plugin registration. CSINode has the same name as a node. If
 * the object is missing, it means either there are no CSI Drivers available on the node, or the
 * Kubelet version is low enough that it doesn't create this object. CSINode has an OwnerReference that
 * points to the corresponding node object.
 *
 * @Kubernetes\Kind("CSINode",group="storage.k8s.io",version="v1beta1")
 * @Kubernetes\Operation("get",path="/apis/storage.k8s.io/v1beta1/csinodes/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/storage.k8s.io/v1beta1/csinodes",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/storage.k8s.io/v1beta1/csinodes/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("put",path="/apis/storage.k8s.io/v1beta1/csinodes/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection-all",path="/apis/storage.k8s.io/v1beta1/csinodes",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/storage.k8s.io/v1beta1/csinodes",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/storage.k8s.io/v1beta1/csinodes/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("list-all",path="/apis/storage.k8s.io/v1beta1/csinodes",response="K8s\Api\Model\Api\Storage\v1beta1\CSINodeList")
 */
class CSINode
{
    /**
