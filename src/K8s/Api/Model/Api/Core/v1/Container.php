...
class Container
{
    ...
    /**
     * @Kubernetes\Attribute("resizePolicy",type="collection",model=ContainerResizePolicy::class)
     ...
     */
    public function getResizePolicy(): ?iterable
    {
     ...
     * @return static
     */
    public function setResizePolicy(iterable $resizePolicy)
    {
     ...
     * @return static
     */
    public function addResizePolicy(ContainerResizePolicy $resizePolicy)
    {
