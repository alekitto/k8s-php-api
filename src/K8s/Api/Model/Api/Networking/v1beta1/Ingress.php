 ...
 *
 * @Kubernetes\Kind("Ingress",group="networking.k8s.io",version="v1beta1")
 * @Kubernetes\Operation("get",path="/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses/{name}",response="static::class")
 * @Kubernetes\Operation("get-status",path="/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses/{name}/status",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch",path="/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("put",path="/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("put-status",path="/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses/{name}/status",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection",path="/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/networking.k8s.io/v1beta1/ingresses",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses/{name}/status",body="patch",response="static::class")
 * @Kubernetes\Operation("list",path="/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses",response="K8s\Api\Model\Api\Networking\v1beta1\IngressList")
 * @Kubernetes\Operation("list-all",path="/apis/networking.k8s.io/v1beta1/ingresses",response="K8s\Api\Model\Api\Networking\v1beta1\IngressList")
 */
class Ingress
{
    /**
