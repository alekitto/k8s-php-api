 ...
 * @Kubernetes\Operation("patch",path="/apis/flowcontrol.apiserver.k8s.io/v1beta3/flowschemas/{name}",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/apis/flowcontrol.apiserver.k8s.io/v1beta3/flowschemas/{name}/status",response="static::class")
