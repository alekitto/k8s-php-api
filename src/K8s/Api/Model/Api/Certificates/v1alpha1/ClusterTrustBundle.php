 ...
 * @Kubernetes\Operation("get",path="/apis/certificates.k8s.io/v1alpha1/clustertrustbundles/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/certificates.k8s.io/v1alpha1/clustertrustbundles",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/certificates.k8s.io/v1alpha1/clustertrustbundles/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("put",path="/apis/certificates.k8s.io/v1alpha1/clustertrustbundles/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection-all",path="/apis/certificates.k8s.io/v1alpha1/clustertrustbundles",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/certificates.k8s.io/v1alpha1/clustertrustbundles",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/certificates.k8s.io/v1alpha1/clustertrustbundles/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("list-all",path="/apis/certificates.k8s.io/v1alpha1/clustertrustbundles",response="K8s\Api\Model\Api\Certificates\v1alpha1\ClusterTrustBundleList")
 */
class ClusterTrustBundle
{
     ...
     * @var string
     */
    protected $apiVersion = 'certificates.k8s.io/v1alpha1';

    /**
     * @Kubernetes\Attribute("kind")
     * @var string
     */
    protected $kind = 'ClusterTrustBundle';
    ...
    /**
     * @Kubernetes\Attribute("spec",type="model",model=ClusterTrustBundleSpec::class,isRequired=true)
     ...
     */
    public function __construct(?string $name, string $trustBundle)
    {
     ...
     * @return static
     */
    public function setSpec(ClusterTrustBundleSpec $spec)
    {
        $this->spec = $spec;
