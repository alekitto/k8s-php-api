 ...
 *
 * @Kubernetes\Kind("VolumeAttachment",group="storage.k8s.io",version="v1alpha1")
 * @Kubernetes\Operation("get",path="/apis/storage.k8s.io/v1alpha1/volumeattachments/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/storage.k8s.io/v1alpha1/volumeattachments",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/storage.k8s.io/v1alpha1/volumeattachments/{name}",body="model",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("put",path="/apis/storage.k8s.io/v1alpha1/volumeattachments/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection-all",path="/apis/storage.k8s.io/v1alpha1/volumeattachments",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/storage.k8s.io/v1alpha1/volumeattachments",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/storage.k8s.io/v1alpha1/volumeattachments/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("list-all",path="/apis/storage.k8s.io/v1alpha1/volumeattachments",response="K8s\Api\Model\Api\Storage\v1alpha1\VolumeAttachmentList")
 */
