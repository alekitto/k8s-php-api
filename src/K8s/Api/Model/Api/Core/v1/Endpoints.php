 ...
 * @Kubernetes\Operation("deletecollection-all",path="/api/v1/namespaces/{namespace}/endpoints",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("patch",path="/api/v1/namespaces/{namespace}/endpoints/{name}",response="static::class")
