...
class ClusterTrustBundleList implements IteratorAggregate
{
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=ClusterTrustBundle::class,isRequired=true)
     ...
     * @var string|null
     */
    protected $kind = 'ClusterTrustBundleList';
     ...
     * @return static
     */
    public function addItems(ClusterTrustBundle $item)
    {
        if (!$this->items) {
