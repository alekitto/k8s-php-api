 ...
 * @Kubernetes\Operation("delete",path="/apis/extensions/v1beta1/namespaces/{namespace}/networkpolicies/{name}",body="model",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
