 ...
 * @Kubernetes\Operation("get",path="/apis/storage.k8s.io/v1alpha1/volumeattributesclasses/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/storage.k8s.io/v1alpha1/volumeattributesclasses",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/storage.k8s.io/v1alpha1/volumeattributesclasses/{name}",response="static::class")
 * @Kubernetes\Operation("put",path="/apis/storage.k8s.io/v1alpha1/volumeattributesclasses/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection-all",path="/apis/storage.k8s.io/v1alpha1/volumeattributesclasses",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("patch",path="/apis/storage.k8s.io/v1alpha1/volumeattributesclasses/{name}",response="static::class")
 * @Kubernetes\Operation("list-all",path="/apis/storage.k8s.io/v1alpha1/volumeattributesclasses",response="K8s\Api\Model\Api\Storage\v1alpha1\VolumeAttributesClassList")
 */
class VolumeAttributesClass
{
     ...
     * @var string|null
     */
    protected $kind = 'VolumeAttributesClass';
