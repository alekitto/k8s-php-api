...
class ClusterRoleBindingService
{
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#list-clusterrolebinding-v1beta1-rbac-authorization-k8s-io
     */
     ...
     * @param array $query
     * @param callable|object|null $handler
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#delete-collection-clusterrolebinding-v1beta1-rbac-authorization-k8s-io
     */
    public function deleteRbacAuthorizationV1beta1Collection(array $query = [], $handler = null): ?Status
    {
        $options['query'] = $query;
        $options['handler'] = $handler;
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#create-clusterrolebinding-v1beta1-rbac-authorization-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#read-clusterrolebinding-v1beta1-rbac-authorization-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#delete-clusterrolebinding-v1beta1-rbac-authorization-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#patch-clusterrolebinding-v1beta1-rbac-authorization-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#put-clusterrolebinding-v1beta1-rbac-authorization-k8s-io
     */
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#watchlist-clusterrolebinding-v1beta1-rbac-authorization-k8s-io
     */
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#watch-clusterrolebinding-v1beta1-rbac-authorization-k8s-io
     */
