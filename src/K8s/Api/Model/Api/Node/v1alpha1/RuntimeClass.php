 ...
 * more details, see https://git.k8s.io/enhancements/keps/sig-node/585-runtime-class
 *
 * @Kubernetes\Kind("RuntimeClass",group="node.k8s.io",version="v1alpha1")
 * @Kubernetes\Operation("get",path="/apis/node.k8s.io/v1alpha1/runtimeclasses/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/node.k8s.io/v1alpha1/runtimeclasses",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/node.k8s.io/v1alpha1/runtimeclasses/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("put",path="/apis/node.k8s.io/v1alpha1/runtimeclasses/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection-all",path="/apis/node.k8s.io/v1alpha1/runtimeclasses",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/node.k8s.io/v1alpha1/runtimeclasses",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/node.k8s.io/v1alpha1/runtimeclasses/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("list-all",path="/apis/node.k8s.io/v1alpha1/runtimeclasses",response="K8s\Api\Model\Api\Node\v1alpha1\RuntimeClassList")
 */
class RuntimeClass
{
    /**
     ...
     * @var string
     */
    protected $apiVersion = 'node.k8s.io/v1alpha1';
    ...
    /**
     * @Kubernetes\Attribute("spec",type="model",model=RuntimeClassSpec::class,isRequired=true)
     ...
     */
    public function __construct(?string $name, string $runtimeHandler)
    {
        $this->metadata = new ObjectMeta($name);
        $this->spec = new RuntimeClassSpec($runtimeHandler);
    }
    ...
    {
        return $this->spec->getRuntimeHandler();
    }
    ...
    {
        $this->spec->setRuntimeHandler($runtimeHandler);
    ...
    {
        return $this->spec->getScheduling();
    }
    ...
    {
        $this->spec->setScheduling($scheduling);
     ...
     */
    public function getSpec(): RuntimeClassSpec
    {
        return $this->spec;
    }
     ...
     * @return static
     */
    public function setSpec(RuntimeClassSpec $spec)
    {
        $this->spec = $spec;
