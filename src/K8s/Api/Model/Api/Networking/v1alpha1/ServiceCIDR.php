 ...
 * @Kubernetes\Operation("get",path="/apis/networking.k8s.io/v1alpha1/servicecidrs/{name}",response="static::class")
 * @Kubernetes\Operation("get-status",path="/apis/networking.k8s.io/v1alpha1/servicecidrs/{name}/status",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/networking.k8s.io/v1alpha1/servicecidrs",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/networking.k8s.io/v1alpha1/servicecidrs/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("put",path="/apis/networking.k8s.io/v1alpha1/servicecidrs/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("put-status",path="/apis/networking.k8s.io/v1alpha1/servicecidrs/{name}/status",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection-all",path="/apis/networking.k8s.io/v1alpha1/servicecidrs",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("patch",path="/apis/networking.k8s.io/v1alpha1/servicecidrs/{name}",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/apis/networking.k8s.io/v1alpha1/servicecidrs/{name}/status",response="static::class")
 * @Kubernetes\Operation("list-all",path="/apis/networking.k8s.io/v1alpha1/servicecidrs",response="K8s\Api\Model\Api\Networking\v1alpha1\ServiceCIDRList")
 */
class ServiceCIDR
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("spec",type="model",model=ServiceCIDRSpec::class)
     * @var ServiceCIDRSpec
     */
    protected $spec;

    /**
     * @Kubernetes\Attribute("status",type="model",model=ServiceCIDRStatus::class)
     * @var ServiceCIDRStatus|null
     */
     ...
     * @return static
     */
    public function setSpec(ServiceCIDRSpec $spec)
    {
        $this->spec = $spec;
     ...
     * https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
     */
    public function getStatus(): ?ServiceCIDRStatus
    {
        return $this->status;
    }
     ...
     * @return static
     */
    public function setStatus(ServiceCIDRStatus $status)
    {
        $this->status = $status;
