...
class ResourceClaimParametersList implements IteratorAggregate
{
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=ResourceClaimParameters::class,isRequired=true)
     ...
     * @var string|null
     */
    protected $kind = 'ResourceClaimParametersList';
     ...
     * @return static
     */
    public function addItems(ResourceClaimParameters $item)
    {
        if (!$this->items) {
