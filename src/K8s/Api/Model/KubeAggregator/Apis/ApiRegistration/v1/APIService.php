 ...
 * @Kubernetes\Operation("patch",path="/apis/apiregistration.k8s.io/v1/apiservices/{name}",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/apis/apiregistration.k8s.io/v1/apiservices/{name}/status",response="static::class")
