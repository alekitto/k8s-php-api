 ...
 *
 * @Kubernetes\Kind("ResourceClass",group="resource.k8s.io",version="v1alpha1")
 * @Kubernetes\Operation("get",path="/apis/resource.k8s.io/v1alpha1/resourceclasses/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/resource.k8s.io/v1alpha1/resourceclasses",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/resource.k8s.io/v1alpha1/resourceclasses/{name}",response="static::class")
 * @Kubernetes\Operation("put",path="/apis/resource.k8s.io/v1alpha1/resourceclasses/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection-all",path="/apis/resource.k8s.io/v1alpha1/resourceclasses",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/resource.k8s.io/v1alpha1/resourceclasses",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/resource.k8s.io/v1alpha1/resourceclasses/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("list-all",path="/apis/resource.k8s.io/v1alpha1/resourceclasses",response="K8s\Api\Model\Api\Resource\v1alpha1\ResourceClassList")
 */
class ResourceClass
{
    /**
