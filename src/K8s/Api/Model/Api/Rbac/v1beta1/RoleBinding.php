 ...
 *
 * @Kubernetes\Kind("RoleBinding",group="rbac.authorization.k8s.io",version="v1beta1")
 * @Kubernetes\Operation("get",path="/apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/rolebindings/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/rolebindings",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/rolebindings/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch",path="/apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/rolebindings",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("put",path="/apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/rolebindings/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection",path="/apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/rolebindings",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/rbac.authorization.k8s.io/v1beta1/rolebindings",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/rolebindings/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("list",path="/apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/rolebindings",response="K8s\Api\Model\Api\Rbac\v1beta1\RoleBindingList")
 * @Kubernetes\Operation("list-all",path="/apis/rbac.authorization.k8s.io/v1beta1/rolebindings",response="K8s\Api\Model\Api\Rbac\v1beta1\RoleBindingList")
 */
class RoleBinding
{
    /**
