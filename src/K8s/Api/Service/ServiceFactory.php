...
use K8s\Api\Service\Batch\v1beta1\CronJobService as v1beta1CronJobService;
...
use K8s\Api\Service\Core\v1\EphemeralContainersService;
...
use K8s\Api\Service\Discovery\v1beta1\EndpointSliceService as v1beta1EndpointSliceService;
...
use K8s\Api\Service\Policy\v1beta1\PodDisruptionBudgetService as v1beta1PodDisruptionBudgetService;
...
use K8s\Api\Service\Storage\v1alpha1\CSIStorageCapacityService;
...
class ServiceFactory
{
    ...
    public function v1CoreEphemeralContainers(): EphemeralContainersService
    {
        return new EphemeralContainersService($this->api);
    }
    ...
    public function v1beta1PolicyPodDisruptionBudget(): v1beta1PodDisruptionBudgetService
    {
        return new v1beta1PodDisruptionBudgetService($this->api);
    }
    ...
    public function v1beta1BatchCronJob(): v1beta1CronJobService
    {
        return new v1beta1CronJobService($this->api);
    }
    ...
    public function v1beta1DiscoveryEndpointSlice(): v1beta1EndpointSliceService
    {
        return new v1beta1EndpointSliceService($this->api);
    }
    ...
    public function v1alpha1StorageCSIStorageCapacity(): CSIStorageCapacityService
    {
