...
class StatefulSet
{
     ...
     * as it is ready) This is an alpha field and requires enabling StatefulSetMinReadySeconds feature
     * gate.
     */
     ...
     * decreasing order on scale down, progressing only when the previous pod is ready or terminated. At
     * most one pod will be changed at any time.
     *  - `"Parallel"` will create and delete pods as soon as the stateful set replica count is changed,
     * and will not wait for pods to be ready or complete termination.
     */
