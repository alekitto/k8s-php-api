...
class PersistentVolumeClaimStatus
{
     ...
     *  - `"Lost"` used for PersistentVolumeClaims that lost their underlying PersistentVolume. The claim
     * was bound to a PersistentVolume and this volume does not exist any longer and all data on it was
     * lost.
