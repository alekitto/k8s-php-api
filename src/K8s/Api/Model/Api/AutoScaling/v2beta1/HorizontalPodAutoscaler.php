 ...
 * specified.
 *
 * @Kubernetes\Kind("HorizontalPodAutoscaler",group="autoscaling",version="v2beta1")
 * @Kubernetes\Operation("get",path="/apis/autoscaling/v2beta1/namespaces/{namespace}/horizontalpodautoscalers/{name}",response="static::class")
 * @Kubernetes\Operation("get-status",path="/apis/autoscaling/v2beta1/namespaces/{namespace}/horizontalpodautoscalers/{name}/status",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/autoscaling/v2beta1/namespaces/{namespace}/horizontalpodautoscalers",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/autoscaling/v2beta1/namespaces/{namespace}/horizontalpodautoscalers/{name}",body="model",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch",path="/apis/autoscaling/v2beta1/namespaces/{namespace}/horizontalpodautoscalers",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("put",path="/apis/autoscaling/v2beta1/namespaces/{namespace}/horizontalpodautoscalers/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("put-status",path="/apis/autoscaling/v2beta1/namespaces/{namespace}/horizontalpodautoscalers/{name}/status",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection",path="/apis/autoscaling/v2beta1/namespaces/{namespace}/horizontalpodautoscalers",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/autoscaling/v2beta1/horizontalpodautoscalers",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/autoscaling/v2beta1/namespaces/{namespace}/horizontalpodautoscalers/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/apis/autoscaling/v2beta1/namespaces/{namespace}/horizontalpodautoscalers/{name}/status",body="patch",response="static::class")
 * @Kubernetes\Operation("list",path="/apis/autoscaling/v2beta1/namespaces/{namespace}/horizontalpodautoscalers",response="K8s\Api\Model\Api\AutoScaling\v2beta1\HorizontalPodAutoscalerList")
 * @Kubernetes\Operation("list-all",path="/apis/autoscaling/v2beta1/horizontalpodautoscalers",response="K8s\Api\Model\Api\AutoScaling\v2beta1\HorizontalPodAutoscalerList")
 */
