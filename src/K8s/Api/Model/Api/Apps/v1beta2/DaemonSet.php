 ...
 *
 * @Kubernetes\Kind("DaemonSet",group="apps",version="v1beta2")
 * @Kubernetes\Operation("get",path="/apis/apps/v1beta2/namespaces/{namespace}/daemonsets/{name}",response="static::class")
 * @Kubernetes\Operation("get-status",path="/apis/apps/v1beta2/namespaces/{namespace}/daemonsets/{name}/status",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/apps/v1beta2/namespaces/{namespace}/daemonsets",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/apps/v1beta2/namespaces/{namespace}/daemonsets/{name}",body="model",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch",path="/apis/apps/v1beta2/namespaces/{namespace}/daemonsets",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("put",path="/apis/apps/v1beta2/namespaces/{namespace}/daemonsets/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("put-status",path="/apis/apps/v1beta2/namespaces/{namespace}/daemonsets/{name}/status",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection",path="/apis/apps/v1beta2/namespaces/{namespace}/daemonsets",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/apps/v1beta2/daemonsets",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/apps/v1beta2/namespaces/{namespace}/daemonsets/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/apis/apps/v1beta2/namespaces/{namespace}/daemonsets/{name}/status",body="patch",response="static::class")
 * @Kubernetes\Operation("list",path="/apis/apps/v1beta2/namespaces/{namespace}/daemonsets",response="K8s\Api\Model\Api\Apps\v1beta2\DaemonSetList")
 * @Kubernetes\Operation("list-all",path="/apis/apps/v1beta2/daemonsets",response="K8s\Api\Model\Api\Apps\v1beta2\DaemonSetList")
 */
class DaemonSet
{
    /**
