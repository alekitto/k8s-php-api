 ...
 *
 * @Kubernetes\Kind("SelfSubjectAccessReview",group="authorization.k8s.io",version="v1beta1")
 * @Kubernetes\Operation("post",path="/apis/authorization.k8s.io/v1beta1/selfsubjectaccessreviews",body="model",response="static::class")
 */
