 ...
 * @Kubernetes\Operation("delete",path="/apis/batch/v1beta1/namespaces/{namespace}/cronjobs/{name}",body="model",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
