...
namespace K8s\Api\Model\Api\Events\v1beta1;
 ...
 * the system.
 *
 * @Kubernetes\Kind("Event",group="events.k8s.io",version="v1beta1")
 * @Kubernetes\Operation("get",path="/apis/events.k8s.io/v1beta1/namespaces/{namespace}/events/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/events.k8s.io/v1beta1/namespaces/{namespace}/events",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/events.k8s.io/v1beta1/namespaces/{namespace}/events/{name}",body="model",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch",path="/apis/events.k8s.io/v1beta1/namespaces/{namespace}/events",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("put",path="/apis/events.k8s.io/v1beta1/namespaces/{namespace}/events/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection",path="/apis/events.k8s.io/v1beta1/namespaces/{namespace}/events",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/events.k8s.io/v1beta1/events",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/events.k8s.io/v1beta1/namespaces/{namespace}/events/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("list",path="/apis/events.k8s.io/v1beta1/namespaces/{namespace}/events",response="K8s\Api\Model\Api\Events\v1beta1\EventList")
 * @Kubernetes\Operation("list-all",path="/apis/events.k8s.io/v1beta1/events",response="K8s\Api\Model\Api\Events\v1beta1\EventList")
 */
class Event
{
    /**
     ...
     * @var string|null
     */
    protected $apiVersion = 'events.k8s.io/v1beta1';
    ...
    /**
     * Optional. A human-readable description of the status of this operation. Maximal length of the note
    ...
    /**
     * The object this Event is about. In most cases it's an Object reporting controller implements. E.g.
     * ReplicaSetController implements ReplicaSets and this event is emitted because it acts on some
    ...
    /**
     * Optional secondary object for more complex actions. E.g. when regarding object triggers a creation
