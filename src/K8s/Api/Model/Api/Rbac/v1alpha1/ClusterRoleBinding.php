 ...
 * the global namespace, and adds who information via Subject. Deprecated in v1.17 in favor of
 * rbac.authorization.k8s.io/v1 ClusterRoleBinding, and will no longer be served in v1.22.
 *
 * @Kubernetes\Kind("ClusterRoleBinding",group="rbac.authorization.k8s.io",version="v1alpha1")
 * @Kubernetes\Operation("get",path="/apis/rbac.authorization.k8s.io/v1alpha1/clusterrolebindings/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/rbac.authorization.k8s.io/v1alpha1/clusterrolebindings",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/rbac.authorization.k8s.io/v1alpha1/clusterrolebindings/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("put",path="/apis/rbac.authorization.k8s.io/v1alpha1/clusterrolebindings/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection-all",path="/apis/rbac.authorization.k8s.io/v1alpha1/clusterrolebindings",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/rbac.authorization.k8s.io/v1alpha1/clusterrolebindings",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/rbac.authorization.k8s.io/v1alpha1/clusterrolebindings/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("list-all",path="/apis/rbac.authorization.k8s.io/v1alpha1/clusterrolebindings",response="K8s\Api\Model\Api\Rbac\v1alpha1\ClusterRoleBindingList")
 */
