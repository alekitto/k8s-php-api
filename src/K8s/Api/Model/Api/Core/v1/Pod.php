 ...
 * @Kubernetes\Operation("delete",path="/api/v1/namespaces/{namespace}/pods/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
...
class Pod
{
     ...
     * Scheduler will schedule pods in a way which abides by the constraints. This field is alpha-level and
     * is only honored by clusters that enables the EvenPodsSpread feature. All topologySpreadConstraints
     * are ANDed.
     *
    ...
    /**
     * Status for any ephemeral containers that have run in this pod. This field is alpha-level and is only
     * populated by servers that enable the EphemeralContainers feature.
     *
     * @return iterable|ContainerStatus[]
     */
