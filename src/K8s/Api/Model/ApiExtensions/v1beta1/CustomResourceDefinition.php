 ...
 * @Kubernetes\Operation("delete",path="/apis/apiextensions.k8s.io/v1beta1/customresourcedefinitions/{name}",body="model",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
...
class CustomResourceDefinition
{
    ...
    /**
     * @Kubernetes\Attribute("spec",type="model",model=CustomResourceDefinitionSpec::class)
