 ...
 * @Kubernetes\Operation("deletecollection-all",path="/api/v1/namespaces/{namespace}/events",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("patch",path="/api/v1/namespaces/{namespace}/events/{name}",response="static::class")
