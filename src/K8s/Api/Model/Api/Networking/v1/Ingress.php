 ...
 * @Kubernetes\Operation("deletecollection-all",path="/apis/networking.k8s.io/v1/namespaces/{namespace}/ingresses",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("patch",path="/apis/networking.k8s.io/v1/namespaces/{namespace}/ingresses/{name}",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/apis/networking.k8s.io/v1/namespaces/{namespace}/ingresses/{name}/status",response="static::class")
