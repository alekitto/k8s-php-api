 ...
 * @Kubernetes\Operation("watch",path="/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaims",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 ...
 * @Kubernetes\Operation("deletecollection",path="/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaims",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/resource.k8s.io/v1alpha2/resourceclaims",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaims/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaims/{name}/status",body="patch",response="static::class")
