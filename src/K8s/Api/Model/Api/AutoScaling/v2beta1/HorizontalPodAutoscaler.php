 ...
 * @Kubernetes\Operation("delete",path="/apis/autoscaling/v2beta1/namespaces/{namespace}/horizontalpodautoscalers/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
