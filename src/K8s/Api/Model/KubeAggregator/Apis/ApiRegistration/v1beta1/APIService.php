 ...
 * @Kubernetes\Operation("delete",path="/apis/apiregistration.k8s.io/v1beta1/apiservices/{name}",body="model",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
