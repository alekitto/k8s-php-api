...
namespace K8s\Api\Model\Api\Authentication\v1alpha1;

use DateTimeInterface;
use K8s\Api\Model\Api\Authentication\v1\UserInfo;
 ...
 * @Kubernetes\Operation("post",path="/apis/authentication.k8s.io/v1alpha1/selfsubjectreviews",body="model",response="static::class")
 */
class SelfSubjectReview
{
     ...
     * @var string|null
     */
    protected $apiVersion = 'authentication.k8s.io/v1alpha1';

    /**
     * @Kubernetes\Attribute("kind")
     * @var string|null
     */
    protected $kind = 'SelfSubjectReview';
    ...
    /**
     * @Kubernetes\Attribute("status",type="model",model=SelfSubjectReviewStatus::class)
     * @var SelfSubjectReviewStatus|null
     */
    ...
    {
        return $this->status->getUserInfo();
    }
     ...
     */
    public function getStatus(): ?SelfSubjectReviewStatus
    {
        return $this->status;
    }
     ...
     * @return static
     */
    public function setStatus(SelfSubjectReviewStatus $status)
    {
        $this->status = $status;
