...
class FlowSchemaService
{
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#list-flowschema-v1alpha1-flowcontrol-apiserver-k8s-io
     */
     ...
     * @param array $query
     * @param callable|null $handler
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#delete-collection-flowschema-v1alpha1-flowcontrol-apiserver-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#create-flowschema-v1alpha1-flowcontrol-apiserver-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#read-flowschema-v1alpha1-flowcontrol-apiserver-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#delete-flowschema-v1alpha1-flowcontrol-apiserver-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#patch-flowschema-v1alpha1-flowcontrol-apiserver-k8s-io
     */
    public function patchFlowControlApiServerV1alpha1(string $name, array $patch, array $query = []): FlowSchema
    {
        $options['query'] = $query;
        $options['body'] = $patch;
        $options['model'] = FlowSchema::class;
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#put-flowschema-v1alpha1-flowcontrol-apiserver-k8s-io
     */
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#patch-flowschema-v1alpha1-flowcontrol-apiserver-k8s-io
     */
    public function patchFlowControlApiServerV1alpha1Status(string $name, array $patch, array $query = []): FlowSchema
    {
        $options['query'] = $query;
        $options['body'] = $patch;
        $options['model'] = FlowSchema::class;
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#watchlist-flowschema-v1alpha1-flowcontrol-apiserver-k8s-io
     */
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#watch-flowschema-v1alpha1-flowcontrol-apiserver-k8s-io
     */
