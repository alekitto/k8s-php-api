...
class PodStatus
{
    ...
    /**
     * @Kubernetes\Attribute("hostIPs",type="collection",model=HostIP::class)
    ...
    /**
     * @Kubernetes\Attribute("resourceClaimStatuses",type="collection",model=PodResourceClaimStatus::class)
     ...
     * @return static
     */
    public function setHostIPs(iterable $hostIPs)
    {
     ...
     * @return static
     */
    public function addHostIPs(HostIP $hostIP)
    {
        if (!$this->hostIPs) {
     ...
     * @return static
     */
    public function setResize(string $resize)
    {
        $this->resize = $resize;
     ...
     * @return static
     */
    public function setResourceClaimStatuses(iterable $resourceClaimStatuses)
    {
     ...
     * @return static
     */
    public function addResourceClaimStatuses(PodResourceClaimStatus $resourceClaimStatuse)
    {
