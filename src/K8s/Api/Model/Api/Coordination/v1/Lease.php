 ...
 * @Kubernetes\Operation("deletecollection-all",path="/apis/coordination.k8s.io/v1/namespaces/{namespace}/leases",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("patch",path="/apis/coordination.k8s.io/v1/namespaces/{namespace}/leases/{name}",response="static::class")
