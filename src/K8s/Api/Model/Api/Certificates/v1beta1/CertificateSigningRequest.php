 ...
 *
 * @Kubernetes\Kind("CertificateSigningRequest",group="certificates.k8s.io",version="v1beta1")
 * @Kubernetes\Operation("get",path="/apis/certificates.k8s.io/v1beta1/certificatesigningrequests/{name}",response="static::class")
 * @Kubernetes\Operation("get-status",path="/apis/certificates.k8s.io/v1beta1/certificatesigningrequests/{name}/status",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/certificates.k8s.io/v1beta1/certificatesigningrequests",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/certificates.k8s.io/v1beta1/certificatesigningrequests/{name}",body="model",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("put",path="/apis/certificates.k8s.io/v1beta1/certificatesigningrequests/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("put-status",path="/apis/certificates.k8s.io/v1beta1/certificatesigningrequests/{name}/status",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection-all",path="/apis/certificates.k8s.io/v1beta1/certificatesigningrequests",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/certificates.k8s.io/v1beta1/certificatesigningrequests",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/certificates.k8s.io/v1beta1/certificatesigningrequests/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/apis/certificates.k8s.io/v1beta1/certificatesigningrequests/{name}/status",body="patch",response="static::class")
 * @Kubernetes\Operation("list-all",path="/apis/certificates.k8s.io/v1beta1/certificatesigningrequests",response="K8s\Api\Model\Api\Certificates\v1beta1\CertificateSigningRequestList")
 */
class CertificateSigningRequest
{
     ...
     * @var string
     */
    protected $apiVersion = 'certificates.k8s.io/v1beta1';
    ...
    /**
     * @Kubernetes\Attribute("spec",type="model",model=CertificateSigningRequestSpec::class)
     ...
     */
    public function __construct(?string $name, string $request)
    {
        $this->metadata = new ObjectMeta($name);
        $this->spec = new CertificateSigningRequestSpec($request);
    }
