 ...
 *
 * @Kubernetes\Kind("InitializerConfigurationList",group="admissionregistration.k8s.io",version="v1alpha1")
 *
 * @implements \IteratorAggregate<int, InitializerConfiguration>
 */
class InitializerConfigurationList implements IteratorAggregate
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=InitializerConfiguration::class,isRequired=true)
     * @var iterable|InitializerConfiguration[]
     */
    protected $items;
     ...
     * @var string|null
     */
    protected $kind = 'InitializerConfigurationList';
    ...
    /**
     * @param iterable|InitializerConfiguration[] $items
     */
    ...
    /**
     * @return ArrayIterator|iterable|InitializerConfiguration[]
     */
     ...
     *
     * @return iterable|InitializerConfiguration[]
     */
     ...
     * @return static
     */
    public function addItems(InitializerConfiguration $item)
    {
        if (!$this->items) {
