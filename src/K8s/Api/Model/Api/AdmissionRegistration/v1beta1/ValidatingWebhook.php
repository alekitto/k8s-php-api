...
{
    /**
     * @Kubernetes\Attribute("admissionReviewVersions")
     * @var string[]|null
     */
     ...
     * to the API Server, calls to the webhook will fail and be subject to the failure policy. Default to
     * `['v1beta1']`.
     */
     ...
     * request may be rejected by a future step in the admission chain and the side effects therefore need
     ...
     * between 1 and 30 seconds. Default to 30 seconds.
     */
