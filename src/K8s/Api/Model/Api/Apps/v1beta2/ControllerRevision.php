 ...
 * See the release notes for more information. ControllerRevision implements an immutable snapshot of
 * state data. Clients are responsible for serializing and deserializing the objects that contain their
 * internal state. Once a ControllerRevision has been successfully created, it can not be updated. The
 * API Server will fail validation of all requests that attempt to mutate the Data field.
 * ControllerRevisions may, however, be deleted. Note that, due to its use by both the DaemonSet and
 * StatefulSet controllers for update and rollback, this object is beta. However, it may be subject to
 * name and representation changes in future releases, and clients should not depend on its stability.
 * It is primarily for internal use by controllers.
 *
 * @Kubernetes\Kind("ControllerRevision",group="apps",version="v1beta2")
 * @Kubernetes\Operation("get",path="/apis/apps/v1beta2/namespaces/{namespace}/controllerrevisions/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/apps/v1beta2/namespaces/{namespace}/controllerrevisions",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/apps/v1beta2/namespaces/{namespace}/controllerrevisions/{name}",body="model",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch",path="/apis/apps/v1beta2/namespaces/{namespace}/controllerrevisions",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("put",path="/apis/apps/v1beta2/namespaces/{namespace}/controllerrevisions/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection",path="/apis/apps/v1beta2/namespaces/{namespace}/controllerrevisions",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/apps/v1beta2/controllerrevisions",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/apps/v1beta2/namespaces/{namespace}/controllerrevisions/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("list",path="/apis/apps/v1beta2/namespaces/{namespace}/controllerrevisions",response="K8s\Api\Model\Api\Apps\v1beta2\ControllerRevisionList")
 * @Kubernetes\Operation("list-all",path="/apis/apps/v1beta2/controllerrevisions",response="K8s\Api\Model\Api\Apps\v1beta2\ControllerRevisionList")
 */
class ControllerRevision
{
    ...
    /**
     * @Kubernetes\Attribute("data",type="model",model=RawExtension::class)
     * @var RawExtension|null
     */
    protected $data = null;
     ...
     */
    public function getData(): ?RawExtension
    {
        return $this->data;
    }
     ...
     * @return static
     */
    public function setData(RawExtension $data)
    {
        $this->data = $data;
