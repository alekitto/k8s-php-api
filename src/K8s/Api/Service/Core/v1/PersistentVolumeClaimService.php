...
class PersistentVolumeClaimService
{
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#list-persistentvolumeclaim-v1-core
     */
    public function listNamespaced(array $query = [], ?callable $handler = null): ?PersistentVolumeClaimList
    {
        $options['query'] = $query;
     ...
     * @param array $query
     * @param callable|null $handler
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#delete-collection-persistentvolumeclaim-v1-core
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#create-persistentvolumeclaim-v1-core
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#read-persistentvolumeclaim-v1-core
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#delete-persistentvolumeclaim-v1-core
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#patch-persistentvolumeclaim-v1-core
     */
    public function patchNamespaced(string $name, array $patch, array $query = []): PersistentVolumeClaim
    {
        $options['query'] = $query;
        $options['body'] = $patch;
        $options['model'] = PersistentVolumeClaim::class;
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#put-persistentvolumeclaim-v1-core
     */
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#patch-persistentvolumeclaim-v1-core
     */
    public function patchNamespacedStatus(string $name, array $patch, array $query = []): PersistentVolumeClaim
    {
        $options['query'] = $query;
        $options['body'] = $patch;
        $options['model'] = PersistentVolumeClaim::class;
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#list-persistentvolumeclaim-v1-core
     */
    public function listForAllNamespaces(array $query = [], ?callable $handler = null): ?PersistentVolumeClaimList
    {
        $options['query'] = $query;
        $options['handler'] = $handler;
        $options['model'] = PersistentVolumeClaimList::class;
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#watchlist-persistentvolumeclaim-v1-core
     */
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#watch-persistentvolumeclaim-v1-core
     */
