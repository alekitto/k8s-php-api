 ...
 * @Kubernetes\Operation("patch",path="/api/v1/nodes/{name}",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/api/v1/nodes/{name}/status",response="static::class")
...
class Node
{
     ...
     */
    public function getRuntimeHandlers(): ?iterable
    {
        return $this->status->getRuntimeHandlers();
    }
