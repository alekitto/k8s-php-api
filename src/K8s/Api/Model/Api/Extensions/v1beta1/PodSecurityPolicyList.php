...
/**
 * PodSecurityPolicyList is a list of PodSecurityPolicy objects. Deprecated: use PodSecurityPolicyList
 * from policy API Group instead.
 *
 * @Kubernetes\Kind("PodSecurityPolicyList",group="extensions",version="v1beta1")
 *
 * @implements \IteratorAggregate<int, PodSecurityPolicy>
 */
class PodSecurityPolicyList implements IteratorAggregate
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=PodSecurityPolicy::class,isRequired=true)
     * @var iterable|PodSecurityPolicy[]
     */
    protected $items;
     ...
     * @var string|null
     */
    protected $kind = 'PodSecurityPolicyList';
    ...
    /**
     * @param iterable|PodSecurityPolicy[] $items
     */
    ...
    /**
     * @return ArrayIterator|iterable|PodSecurityPolicy[]
     */
     ...
     *
     * @return iterable|PodSecurityPolicy[]
     */
     ...
     * @return static
     */
    public function addItems(PodSecurityPolicy $item)
    {
        if (!$this->items) {
