 ...
 * @Kubernetes\Operation("deletecollection-all",path="/apis/storage.k8s.io/v1/namespaces/{namespace}/csistoragecapacities",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("patch",path="/apis/storage.k8s.io/v1/namespaces/{namespace}/csistoragecapacities/{name}",response="static::class")
