 ...
 *
 * @Kubernetes\Kind("PodPresetList",group="settings.k8s.io",version="v1alpha1")
 *
 * @implements \IteratorAggregate<int, PodPreset>
 */
class PodPresetList implements IteratorAggregate
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=PodPreset::class,isRequired=true)
     * @var iterable|PodPreset[]
     */
    protected $items;
    ...
    /**
     * @param iterable|PodPreset[] $items
     */
    ...
    /**
     * @return ArrayIterator|iterable|PodPreset[]
     */
     ...
     * @return static
     */
    public function addItems(PodPreset $item)
    {
        if (!$this->items) {
