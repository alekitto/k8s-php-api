 ...
 * @Kubernetes\Operation("deletecollection-all",path="/apis/apps/v1/namespaces/{namespace}/statefulsets",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("patch",path="/apis/apps/v1/namespaces/{namespace}/statefulsets/{name}",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/apis/apps/v1/namespaces/{namespace}/statefulsets/{name}/status",response="static::class")
...
class StatefulSet
{
     ...
     * which is beta.
     */
    public function getOrdinals(): ?StatefulSetOrdinals
    {
     ...
     * @return static
     */
    public function setOrdinals(StatefulSetOrdinals $ordinals)
    {
