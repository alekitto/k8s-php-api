 ...
 * ObjectMeta.Name.
 *
 * @Kubernetes\Kind("StorageClass",group="storage.k8s.io",version="v1beta1")
 * @Kubernetes\Operation("get",path="/apis/storage.k8s.io/v1beta1/storageclasses/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/storage.k8s.io/v1beta1/storageclasses",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/storage.k8s.io/v1beta1/storageclasses/{name}",body="model",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("put",path="/apis/storage.k8s.io/v1beta1/storageclasses/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection-all",path="/apis/storage.k8s.io/v1beta1/storageclasses",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/storage.k8s.io/v1beta1/storageclasses",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/storage.k8s.io/v1beta1/storageclasses/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("list-all",path="/apis/storage.k8s.io/v1beta1/storageclasses",response="K8s\Api\Model\Api\Storage\v1beta1\StorageClassList")
 */
class StorageClass
{
    /**
     ...
     * no topology restriction. This field is alpha-level and is only honored by servers that enable the
     ...
     * VolumeBindingImmediate is used. This field is alpha-level and is only honored by servers that enable
