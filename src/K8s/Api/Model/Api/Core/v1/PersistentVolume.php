 ...
 * @Kubernetes\Operation("delete",path="/api/v1/persistentvolumes/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
...
class PersistentVolume
{
     ...
     * raw block state. Value of Filesystem is implied when not included in spec. This is a beta feature.
     */
