...
/**
 * PodSecurityPolicySpec defines the policy enforced. Deprecated: use PodSecurityPolicySpec from policy
 * API Group instead.
 */
class PodSecurityPolicySpec
{
     ...
     * @var string[]|null
     */
    protected $requiredDropCapabilities;
