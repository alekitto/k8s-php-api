 ...
 *
 * @Kubernetes\Kind("MutatingWebhookConfiguration",group="admissionregistration.k8s.io",version="v1beta1")
 * @Kubernetes\Operation("get",path="/apis/admissionregistration.k8s.io/v1beta1/mutatingwebhookconfigurations/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/admissionregistration.k8s.io/v1beta1/mutatingwebhookconfigurations",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/admissionregistration.k8s.io/v1beta1/mutatingwebhookconfigurations/{name}",body="model",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("put",path="/apis/admissionregistration.k8s.io/v1beta1/mutatingwebhookconfigurations/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection-all",path="/apis/admissionregistration.k8s.io/v1beta1/mutatingwebhookconfigurations",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/admissionregistration.k8s.io/v1beta1/mutatingwebhookconfigurations",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/admissionregistration.k8s.io/v1beta1/mutatingwebhookconfigurations/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("list-all",path="/apis/admissionregistration.k8s.io/v1beta1/mutatingwebhookconfigurations",response="K8s\Api\Model\Api\AdmissionRegistration\v1beta1\MutatingWebhookConfigurationList")
 */
