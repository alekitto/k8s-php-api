...
class LifecycleHandler
{
    ...
    /**
     * @Kubernetes\Attribute("sleep",type="model",model=SleepAction::class)
     ...
     * @param SleepAction|null $sleep
     * @param TCPSocketAction|null $tcpSocket
     */
    public function __construct(?ExecAction $exec = null, ?HTTPGetAction $httpGet = null, ?SleepAction $sleep = null, ?TCPSocketAction $tcpSocket = null)
    {
        $this->exec = $exec;
     ...
     */
    public function getSleep(): ?SleepAction
    {
        return $this->sleep;
    }
     ...
     * @return static
     */
    public function setSleep(SleepAction $sleep)
    {
        $this->sleep = $sleep;
