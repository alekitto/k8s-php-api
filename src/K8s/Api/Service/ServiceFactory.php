...
/**
 * This file was automatically generated by k8s/api-generator 0.12.0 for API version v1.30.10
 *
...
use K8s\Api\Service\AdmissionRegistration\v1\ValidatingAdmissionPolicyBindingService;
use K8s\Api\Service\AdmissionRegistration\v1\ValidatingAdmissionPolicyService;
use K8s\Api\Service\AdmissionRegistration\v1\ValidatingWebhookConfigurationService;
use K8s\Api\Service\AdmissionRegistration\v1alpha1\ValidatingAdmissionPolicyBindingService as v1alpha1ValidatingAdmissionPolicyBindingService;
use K8s\Api\Service\AdmissionRegistration\v1alpha1\ValidatingAdmissionPolicyService as v1alpha1ValidatingAdmissionPolicyService;
use K8s\Api\Service\AdmissionRegistration\v1beta1\ValidatingAdmissionPolicyBindingService as v1beta1ValidatingAdmissionPolicyBindingService;
use K8s\Api\Service\AdmissionRegistration\v1beta1\ValidatingAdmissionPolicyService as v1beta1ValidatingAdmissionPolicyService;
...
use K8s\Api\Service\Authentication\v1\SelfSubjectReviewService;
use K8s\Api\Service\Authentication\v1\TokenRequestService;
use K8s\Api\Service\Authentication\v1\TokenReviewService;
use K8s\Api\Service\Authentication\v1alpha1\SelfSubjectReviewService as v1alpha1SelfSubjectReviewService;
use K8s\Api\Service\Authentication\v1beta1\SelfSubjectReviewService as v1beta1SelfSubjectReviewService;
...
use K8s\Api\Service\Certificates\v1alpha1\ClusterTrustBundleService;
...
use K8s\Api\Service\FlowControl\ApiServer\v1\FlowSchemaService;
use K8s\Api\Service\FlowControl\ApiServer\v1\PriorityLevelConfigurationService;
use K8s\Api\Service\FlowControl\ApiServer\v1beta3\FlowSchemaService as v1beta3FlowSchemaService;
use K8s\Api\Service\FlowControl\ApiServer\v1beta3\PriorityLevelConfigurationService as v1beta3PriorityLevelConfigurationService;
...
use K8s\Api\Service\Networking\v1alpha1\IPAddressService;
use K8s\Api\Service\Networking\v1alpha1\ServiceCIDRService;
...
use K8s\Api\Service\Resource\v1alpha2\PodSchedulingContextService;
use K8s\Api\Service\Resource\v1alpha2\ResourceClaimParametersService;
use K8s\Api\Service\Resource\v1alpha2\ResourceClaimService;
use K8s\Api\Service\Resource\v1alpha2\ResourceClaimTemplateService;
use K8s\Api\Service\Resource\v1alpha2\ResourceClassParametersService;
use K8s\Api\Service\Resource\v1alpha2\ResourceClassService;
use K8s\Api\Service\Resource\v1alpha2\ResourceSliceService;
...
use K8s\Api\Service\Storage\v1alpha1\VolumeAttributesClassService;
use K8s\Api\Service\Storagemigration\v1alpha1\StorageVersionMigrationService;
...
class ServiceFactory
{
    ...
    public function v1alpha1AuthenticationSelfSubjectReview(): v1alpha1SelfSubjectReviewService
    {
        return new v1alpha1SelfSubjectReviewService($this->api);
    }

    public function v1beta1AuthenticationSelfSubjectReview(): v1beta1SelfSubjectReviewService
    {
        return new v1beta1SelfSubjectReviewService($this->api);
    }
    ...
    public function v1alpha1AdmissionregistrationValidatingAdmissionPolicy(): v1alpha1ValidatingAdmissionPolicyService
    {
        return new v1alpha1ValidatingAdmissionPolicyService($this->api);
    }

    public function v1beta1AdmissionregistrationValidatingAdmissionPolicy(): v1beta1ValidatingAdmissionPolicyService
    {
        return new v1beta1ValidatingAdmissionPolicyService($this->api);
    }
    ...
    public function v1alpha1AdmissionregistrationValidatingAdmissionPolicyBinding(): v1alpha1ValidatingAdmissionPolicyBindingService
    {
        return new v1alpha1ValidatingAdmissionPolicyBindingService($this->api);
    }

    public function v1beta1AdmissionregistrationValidatingAdmissionPolicyBinding(): v1beta1ValidatingAdmissionPolicyBindingService
    {
        return new v1beta1ValidatingAdmissionPolicyBindingService($this->api);
    }
    ...
    public function v1beta3FlowcontrolFlowSchema(): v1beta3FlowSchemaService
    {
        return new v1beta3FlowSchemaService($this->api);
    }
    ...
    public function v1beta3FlowcontrolPriorityLevelConfiguration(): v1beta3PriorityLevelConfigurationService
    {
        return new v1beta3PriorityLevelConfigurationService($this->api);
    }
