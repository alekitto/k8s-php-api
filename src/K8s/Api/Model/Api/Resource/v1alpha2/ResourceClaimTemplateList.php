...
class ResourceClaimTemplateList implements IteratorAggregate
{
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=ResourceClaimTemplate::class,isRequired=true)
     ...
     * @var string|null
     */
    protected $kind = 'ResourceClaimTemplateList';
     ...
     * @return static
     */
    public function addItems(ResourceClaimTemplate $item)
    {
        if (!$this->items) {
