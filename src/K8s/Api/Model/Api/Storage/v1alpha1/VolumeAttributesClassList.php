...
class VolumeAttributesClassList implements IteratorAggregate
{
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=VolumeAttributesClass::class,isRequired=true)
     ...
     * @var string|null
     */
    protected $kind = 'VolumeAttributesClassList';
     ...
     * @return static
     */
    public function addItems(VolumeAttributesClass $item)
    {
        if (!$this->items) {
