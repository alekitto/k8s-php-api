 ...
 * @Kubernetes\Operation("delete",path="/apis/apps/v1/namespaces/{namespace}/replicasets/{name}",body="model",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
