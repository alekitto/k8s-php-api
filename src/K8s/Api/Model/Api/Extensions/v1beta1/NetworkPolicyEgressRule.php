 ...
 * networking/v1/NetworkPolicyEgressRule. NetworkPolicyEgressRule describes a particular set of traffic
 * that is allowed out of pods matched by a NetworkPolicySpec's podSelector. The traffic must match
