...
class ComponentStatusService
{
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#list-componentstatus-v1-core
     */
    public function list(array $query = []): ComponentStatusList
    {
        $options['query'] = $query;
        $options['method'] = 'get';
     ...
     * @param array $query
     * @deprecated This API is deprecated in v1.19+
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#read-componentstatus-v1-core
     */
