 ...
 * reject and object without changing it. Deprecated in v1.16, planned for removal in v1.19. Use
 ...
 * @Kubernetes\Operation("delete",path="/apis/admissionregistration.k8s.io/v1beta1/validatingwebhookconfigurations/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
