...
class HorizontalPodAutoscalerStatus
{
    ...
    /**
     * @Kubernetes\Attribute("currentMetrics",type="collection",model=MetricStatus::class,isRequired=true)
     * @var iterable|MetricStatus[]
     */
     ...
     * @param iterable|MetricStatus[] $currentMetrics
     * @param int $currentReplicas
     * @param int $desiredReplicas
     */
    public function __construct(iterable $conditions, iterable $currentMetrics, int $currentReplicas, int $desiredReplicas)
    {
        $this->conditions = new Collection($conditions);
        $this->currentMetrics = new Collection($currentMetrics);
