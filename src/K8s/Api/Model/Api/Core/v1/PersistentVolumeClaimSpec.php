...
class PersistentVolumeClaimSpec
{
    ...
    /**
     * @Kubernetes\Attribute("dataSourceRef",type="model",model=TypedObjectReference::class)
     * @var TypedObjectReference|null
     */
    protected $dataSourceRef = null;

    /**
     * @Kubernetes\Attribute("resources",type="model",model=VolumeResourceRequirements::class)
     * @var VolumeResourceRequirements|null
     */
     ...
     * @var string|null
     */
    protected $volumeAttributesClassName = null;
