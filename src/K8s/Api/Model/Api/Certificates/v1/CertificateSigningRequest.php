 ...
 * @Kubernetes\Operation("patch",path="/apis/certificates.k8s.io/v1/certificatesigningrequests/{name}",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/apis/certificates.k8s.io/v1/certificatesigningrequests/{name}/status",response="static::class")
