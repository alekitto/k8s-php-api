...
class RoleBindingService
{
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#list-rolebinding-v1beta1-rbac-authorization-k8s-io
     */
     ...
     * @param array $query
     * @param callable|null $handler
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#delete-collection-rolebinding-v1beta1-rbac-authorization-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#create-rolebinding-v1beta1-rbac-authorization-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#read-rolebinding-v1beta1-rbac-authorization-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#delete-rolebinding-v1beta1-rbac-authorization-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#patch-rolebinding-v1beta1-rbac-authorization-k8s-io
     */
    public function patchRbacAuthorizationV1beta1Namespaced(string $name, array $patch, array $query = []): RoleBinding
    {
        $options['query'] = $query;
        $options['body'] = $patch;
        $options['model'] = RoleBinding::class;
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#put-rolebinding-v1beta1-rbac-authorization-k8s-io
     */
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#watchlist-rolebinding-v1beta1-rbac-authorization-k8s-io
     */
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#watch-rolebinding-v1beta1-rbac-authorization-k8s-io
     */
