...
class ResourceClassParametersList implements IteratorAggregate
{
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=ResourceClassParameters::class,isRequired=true)
     ...
     * @var string|null
     */
    protected $kind = 'ResourceClassParametersList';
     ...
     * @return static
     */
    public function addItems(ResourceClassParameters $item)
    {
        if (!$this->items) {
