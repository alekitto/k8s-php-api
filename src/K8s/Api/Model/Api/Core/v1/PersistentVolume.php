 ...
 * @Kubernetes\Operation("patch",path="/api/v1/persistentvolumes/{name}",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/api/v1/persistentvolumes/{name}/status",response="static::class")
...
class PersistentVolume
{
    ...
    {
        return $this->status->getLastPhaseTransitionTime();
    }
