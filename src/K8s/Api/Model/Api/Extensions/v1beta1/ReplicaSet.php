 ...
 * release notes for more information. ReplicaSet ensures that a specified number of pod replicas are
 * running at any given time.
 *
 * @Kubernetes\Kind("ReplicaSet",group="extensions",version="v1beta1")
 * @Kubernetes\Operation("get",path="/apis/extensions/v1beta1/namespaces/{namespace}/replicasets/{name}",response="static::class")
 * @Kubernetes\Operation("get-status",path="/apis/extensions/v1beta1/namespaces/{namespace}/replicasets/{name}/status",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/extensions/v1beta1/namespaces/{namespace}/replicasets",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/extensions/v1beta1/namespaces/{namespace}/replicasets/{name}",body="model",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch",path="/apis/extensions/v1beta1/namespaces/{namespace}/replicasets",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("put",path="/apis/extensions/v1beta1/namespaces/{namespace}/replicasets/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("put-status",path="/apis/extensions/v1beta1/namespaces/{namespace}/replicasets/{name}/status",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection",path="/apis/extensions/v1beta1/namespaces/{namespace}/replicasets",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/extensions/v1beta1/replicasets",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/extensions/v1beta1/namespaces/{namespace}/replicasets/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/apis/extensions/v1beta1/namespaces/{namespace}/replicasets/{name}/status",body="patch",response="static::class")
 * @Kubernetes\Operation("list",path="/apis/extensions/v1beta1/namespaces/{namespace}/replicasets",response="K8s\Api\Model\Api\Extensions\v1beta1\ReplicaSetList")
 * @Kubernetes\Operation("list-all",path="/apis/extensions/v1beta1/replicasets",response="K8s\Api\Model\Api\Extensions\v1beta1\ReplicaSetList")
 */
class ReplicaSet
{
    /**
