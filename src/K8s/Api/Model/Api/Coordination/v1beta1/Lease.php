...
namespace K8s\Api\Model\Api\Coordination\v1beta1;
 ...
 *
 * @Kubernetes\Kind("Lease",group="coordination.k8s.io",version="v1beta1")
 * @Kubernetes\Operation("get",path="/apis/coordination.k8s.io/v1beta1/namespaces/{namespace}/leases/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/coordination.k8s.io/v1beta1/namespaces/{namespace}/leases",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/coordination.k8s.io/v1beta1/namespaces/{namespace}/leases/{name}",body="model",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch",path="/apis/coordination.k8s.io/v1beta1/namespaces/{namespace}/leases",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("put",path="/apis/coordination.k8s.io/v1beta1/namespaces/{namespace}/leases/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection",path="/apis/coordination.k8s.io/v1beta1/namespaces/{namespace}/leases",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/coordination.k8s.io/v1beta1/leases",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/coordination.k8s.io/v1beta1/namespaces/{namespace}/leases/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("list",path="/apis/coordination.k8s.io/v1beta1/namespaces/{namespace}/leases",response="K8s\Api\Model\Api\Coordination\v1beta1\LeaseList")
 * @Kubernetes\Operation("list-all",path="/apis/coordination.k8s.io/v1beta1/leases",response="K8s\Api\Model\Api\Coordination\v1beta1\LeaseList")
 */
class Lease
{
    /**
     ...
     * @var string
     */
    protected $apiVersion = 'coordination.k8s.io/v1beta1';
