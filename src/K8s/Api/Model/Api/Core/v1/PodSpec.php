...
class PodSpec
{
    ...
    /**
     * @Kubernetes\Attribute("resourceClaims",type="collection",model=PodResourceClaim::class)
    ...
    /**
     * @Kubernetes\Attribute("schedulingGates",type="collection",model=PodSchedulingGate::class)
    ...
    /**
     * SchedulingGates is an opaque list of values that if specified will block scheduling the pod. More
