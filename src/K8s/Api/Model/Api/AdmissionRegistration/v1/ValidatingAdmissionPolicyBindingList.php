...
class ValidatingAdmissionPolicyBindingList implements IteratorAggregate
{
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=ValidatingAdmissionPolicyBinding::class,isRequired=true)
     ...
     * @var string|null
     */
    protected $kind = 'ValidatingAdmissionPolicyBindingList';
     ...
     * @return static
     */
    public function addItems(ValidatingAdmissionPolicyBinding $item)
    {
        if (!$this->items) {
