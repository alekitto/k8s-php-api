 ...
 * @Kubernetes\Operation("get",path="/apis/resource.k8s.io/v1alpha2/resourceclasses/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/resource.k8s.io/v1alpha2/resourceclasses",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/resource.k8s.io/v1alpha2/resourceclasses/{name}",response="static::class")
 * @Kubernetes\Operation("put",path="/apis/resource.k8s.io/v1alpha2/resourceclasses/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection-all",path="/apis/resource.k8s.io/v1alpha2/resourceclasses",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("patch",path="/apis/resource.k8s.io/v1alpha2/resourceclasses/{name}",response="static::class")
 * @Kubernetes\Operation("list-all",path="/apis/resource.k8s.io/v1alpha2/resourceclasses",response="K8s\Api\Model\Api\Resource\v1alpha2\ResourceClassList")
 */
class ResourceClass
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("driverName",isRequired=true)
     * @var string
     */
    ...
    /**
     * @Kubernetes\Attribute("parametersRef",type="model",model=ResourceClassParametersReference::class)
     ...
     * @var bool|null
     */
    protected $structuredParameters = null;

    /**
     * @Kubernetes\Attribute("suitableNodes",type="model",model=NodeSelector::class)
     * @var NodeSelector|null
     */
    protected $suitableNodes = null;

    /**
     * @param string $driverName
     */
    public function __construct(?string $name, string $driverName)
    {
     ...
     */
    public function getParametersRef(): ?ResourceClassParametersReference
    {
     ...
     * @return static
     */
    public function setParametersRef(ResourceClassParametersReference $parametersRef)
    {
     ...
     */
    public function isStructuredParameters(): ?bool
    {
     ...
     * @return static
     */
    public function setIsStructuredParameters(bool $structuredParameters)
    {
     ...
     */
    public function getSuitableNodes(): ?NodeSelector
    {
     ...
     * @return static
     */
    public function setSuitableNodes(NodeSelector $suitableNodes)
    {
