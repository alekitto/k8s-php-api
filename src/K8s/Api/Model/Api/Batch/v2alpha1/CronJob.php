 ...
 *
 * @Kubernetes\Kind("CronJob",group="batch",version="v2alpha1")
 * @Kubernetes\Operation("get",path="/apis/batch/v2alpha1/namespaces/{namespace}/cronjobs/{name}",response="static::class")
 * @Kubernetes\Operation("get-status",path="/apis/batch/v2alpha1/namespaces/{namespace}/cronjobs/{name}/status",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/batch/v2alpha1/namespaces/{namespace}/cronjobs",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/batch/v2alpha1/namespaces/{namespace}/cronjobs/{name}",body="model",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch",path="/apis/batch/v2alpha1/namespaces/{namespace}/cronjobs",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("put",path="/apis/batch/v2alpha1/namespaces/{namespace}/cronjobs/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("put-status",path="/apis/batch/v2alpha1/namespaces/{namespace}/cronjobs/{name}/status",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection",path="/apis/batch/v2alpha1/namespaces/{namespace}/cronjobs",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/batch/v2alpha1/cronjobs",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/batch/v2alpha1/namespaces/{namespace}/cronjobs/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/apis/batch/v2alpha1/namespaces/{namespace}/cronjobs/{name}/status",body="patch",response="static::class")
 * @Kubernetes\Operation("list",path="/apis/batch/v2alpha1/namespaces/{namespace}/cronjobs",response="K8s\Api\Model\Api\Batch\v2alpha1\CronJobList")
 * @Kubernetes\Operation("list-all",path="/apis/batch/v2alpha1/cronjobs",response="K8s\Api\Model\Api\Batch\v2alpha1\CronJobList")
 */
class CronJob
{
    /**
