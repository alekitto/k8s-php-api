...
class NodeStatus
{
    ...
    /**
     * @Kubernetes\Attribute("runtimeHandlers",type="collection",model=NodeRuntimeHandler::class)
     ...
     * @return static
     */
    public function setRuntimeHandlers(iterable $runtimeHandlers)
    {
     ...
     * @return static
     */
    public function addRuntimeHandlers(NodeRuntimeHandler $runtimeHandler)
    {
