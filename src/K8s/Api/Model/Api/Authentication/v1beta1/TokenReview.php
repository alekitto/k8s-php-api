 ...
 *
 * @Kubernetes\Kind("TokenReview",group="authentication.k8s.io",version="v1beta1")
 * @Kubernetes\Operation("post",path="/apis/authentication.k8s.io/v1beta1/tokenreviews",body="model",response="static::class")
 */
class TokenReview
{
    /**
     ...
     * @var string
     */
    protected $apiVersion = 'authentication.k8s.io/v1beta1';
