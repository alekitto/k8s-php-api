 ...
 * @Kubernetes\Operation("deletecollection-all",path="/apis/discovery.k8s.io/v1/namespaces/{namespace}/endpointslices",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("patch",path="/apis/discovery.k8s.io/v1/namespaces/{namespace}/endpointslices/{name}",response="static::class")
