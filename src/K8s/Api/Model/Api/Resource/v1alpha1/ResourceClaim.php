 ...
 *
 * @Kubernetes\Kind("ResourceClaim",group="resource.k8s.io",version="v1alpha1")
 * @Kubernetes\Operation("get",path="/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/resourceclaims/{name}",response="static::class")
 * @Kubernetes\Operation("get-status",path="/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/resourceclaims/{name}/status",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/resourceclaims",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/resourceclaims/{name}",response="static::class")
 * @Kubernetes\Operation("watch",path="/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/resourceclaims",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("put",path="/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/resourceclaims/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("put-status",path="/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/resourceclaims/{name}/status",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection",path="/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/resourceclaims",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/resource.k8s.io/v1alpha1/resourceclaims",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/resourceclaims/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/resourceclaims/{name}/status",body="patch",response="static::class")
 * @Kubernetes\Operation("list",path="/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/resourceclaims",response="K8s\Api\Model\Api\Resource\v1alpha1\ResourceClaimList")
 * @Kubernetes\Operation("list-all",path="/apis/resource.k8s.io/v1alpha1/resourceclaims",response="K8s\Api\Model\Api\Resource\v1alpha1\ResourceClaimList")
 */
class ResourceClaim
{
    /**
     ...
     * @var string
     */
    protected $apiVersion = 'resource.k8s.io/v1alpha1';
    ...
    /**
     * Allocation is set by the resource driver once a resource has been allocated successfully. If this is
     * not specified, the resource is not yet allocated.
     */
