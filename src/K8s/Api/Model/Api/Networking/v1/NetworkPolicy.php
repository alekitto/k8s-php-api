 ...
 * @Kubernetes\Operation("deletecollection-all",path="/apis/networking.k8s.io/v1/namespaces/{namespace}/networkpolicies",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("patch",path="/apis/networking.k8s.io/v1/namespaces/{namespace}/networkpolicies/{name}",response="static::class")
