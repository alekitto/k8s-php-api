 ...
 * @Kubernetes\Operation("get",path="/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclassparameters/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclassparameters",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclassparameters/{name}",response="static::class")
 * @Kubernetes\Operation("put",path="/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclassparameters/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection-all",path="/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclassparameters",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("patch",path="/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclassparameters/{name}",response="static::class")
 * @Kubernetes\Operation("list",path="/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclassparameters",response="K8s\Api\Model\Api\Resource\v1alpha2\ResourceClassParametersList")
 * @Kubernetes\Operation("list-all",path="/apis/resource.k8s.io/v1alpha2/resourceclassparameters",response="K8s\Api\Model\Api\Resource\v1alpha2\ResourceClassParametersList")
 */
class ResourceClassParameters
{
    ...
    /**
     * @Kubernetes\Attribute("filters",type="collection",model=ResourceFilter::class)
     * @var iterable|ResourceFilter[]|null
     */
    protected $filters = null;

    /**
     * @Kubernetes\Attribute("generatedFrom",type="model",model=ResourceClassParametersReference::class)
     * @var ResourceClassParametersReference|null
     */
    protected $generatedFrom = null;

    /**
     * @Kubernetes\Attribute("kind")
     * @var string|null
     */
    protected $kind = 'ResourceClassParameters';
    ...
    /**
     * @Kubernetes\Attribute("vendorParameters",type="collection",model=VendorParameters::class)
     ...
     * @return static
     */
    public function addFilters(ResourceFilter $filter)
    {
        if (!$this->filters) {
     ...
     */
    public function getGeneratedFrom(): ?ResourceClassParametersReference
    {
     ...
     * @return static
     */
    public function setGeneratedFrom(ResourceClassParametersReference $generatedFrom)
    {
     ...
     */
    public function getVendorParameters(): ?iterable
    {
     ...
     * @return static
     */
    public function setVendorParameters(iterable $vendorParameters)
    {
     ...
     * @return static
     */
    public function addVendorParameters(VendorParameters $vendorParameter)
    {
