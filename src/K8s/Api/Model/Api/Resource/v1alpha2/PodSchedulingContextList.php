...
class PodSchedulingContextList implements IteratorAggregate
{
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=PodSchedulingContext::class,isRequired=true)
     ...
     * @var string|null
     */
    protected $kind = 'PodSchedulingContextList';
     ...
     * @return static
     */
    public function addItems(PodSchedulingContext $item)
    {
        if (!$this->items) {
