...
class ValidatingAdmissionPolicyList implements IteratorAggregate
{
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=ValidatingAdmissionPolicy::class,isRequired=true)
     ...
     * @var string|null
     */
    protected $kind = 'ValidatingAdmissionPolicyList';
     ...
     * @return static
     */
    public function addItems(ValidatingAdmissionPolicy $item)
    {
        if (!$this->items) {
