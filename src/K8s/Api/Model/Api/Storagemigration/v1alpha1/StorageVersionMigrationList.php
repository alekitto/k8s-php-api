...
class StorageVersionMigrationList implements IteratorAggregate
{
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=StorageVersionMigration::class,isRequired=true)
     ...
     * @var string|null
     */
    protected $kind = 'StorageVersionMigrationList';
     ...
     * @return static
     */
    public function addItems(StorageVersionMigration $item)
    {
        if (!$this->items) {
