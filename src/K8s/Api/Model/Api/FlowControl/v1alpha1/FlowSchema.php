 ...
 *
 * @Kubernetes\Kind("FlowSchema",group="flowcontrol.apiserver.k8s.io",version="v1alpha1")
 * @Kubernetes\Operation("get",path="/apis/flowcontrol.apiserver.k8s.io/v1alpha1/flowschemas/{name}",response="static::class")
 * @Kubernetes\Operation("get-status",path="/apis/flowcontrol.apiserver.k8s.io/v1alpha1/flowschemas/{name}/status",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/flowcontrol.apiserver.k8s.io/v1alpha1/flowschemas",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/flowcontrol.apiserver.k8s.io/v1alpha1/flowschemas/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("put",path="/apis/flowcontrol.apiserver.k8s.io/v1alpha1/flowschemas/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("put-status",path="/apis/flowcontrol.apiserver.k8s.io/v1alpha1/flowschemas/{name}/status",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection-all",path="/apis/flowcontrol.apiserver.k8s.io/v1alpha1/flowschemas",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/flowcontrol.apiserver.k8s.io/v1alpha1/flowschemas",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/flowcontrol.apiserver.k8s.io/v1alpha1/flowschemas/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/apis/flowcontrol.apiserver.k8s.io/v1alpha1/flowschemas/{name}/status",body="patch",response="static::class")
 * @Kubernetes\Operation("list-all",path="/apis/flowcontrol.apiserver.k8s.io/v1alpha1/flowschemas",response="K8s\Api\Model\Api\FlowControl\v1alpha1\FlowSchemaList")
 */
class FlowSchema
{
    /**
     ...
     * MatchingPrecedence.  Each MatchingPrecedence value must be non-negative. Note that if the precedence
     * is not specified or zero, it will be set to 1000 as default.
     */
