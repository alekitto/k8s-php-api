...
class CertificateSigningRequestService
{
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.19/#list-certificatesigningrequest-v1beta1-certificates-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.19/#delete-collection-certificatesigningrequest-v1beta1-certificates-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.19/#create-certificatesigningrequest-v1beta1-certificates-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.19/#read-certificatesigningrequest-v1beta1-certificates-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.19/#delete-certificatesigningrequest-v1beta1-certificates-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.19/#patch-certificatesigningrequest-v1beta1-certificates-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.19/#put-certificatesigningrequest-v1beta1-certificates-k8s-io
     */
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.19/#patch-certificatesigningrequest-v1beta1-certificates-k8s-io
     */
    public function patchCertificatesV1beta1Approval(string $name, array $patch, array $query = []): CertificateSigningRequest
    {
        $options['query'] = $query;
        $options['body'] = $patch;
        $options['model'] = CertificateSigningRequest::class;
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.19/#watchlist-certificatesigningrequest-v1beta1-certificates-k8s-io
     */
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.19/#watch-certificatesigningrequest-v1beta1-certificates-k8s-io
     */
