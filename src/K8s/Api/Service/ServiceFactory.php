...
use K8s\Api\Service\Resource\v1alpha1\PodSchedulingService;
use K8s\Api\Service\Resource\v1alpha1\ResourceClaimService;
use K8s\Api\Service\Resource\v1alpha1\ResourceClaimTemplateService;
use K8s\Api\Service\Resource\v1alpha1\ResourceClassService;
...
class ServiceFactory
{
    ...
    public function v1alpha1ResourcePodScheduling(): PodSchedulingService
    {
        return new PodSchedulingService($this->api);
    }

    public function v1alpha1ResourceResourceClaim(): ResourceClaimService
    {
        return new ResourceClaimService($this->api);
    }

    public function v1alpha1ResourceResourceClaimTemplate(): ResourceClaimTemplateService
    {
        return new ResourceClaimTemplateService($this->api);
    }

    public function v1alpha1ResourceResourceClass(): ResourceClassService
    {
