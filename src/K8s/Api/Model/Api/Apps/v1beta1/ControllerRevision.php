 ...
 * @Kubernetes\Operation("delete",path="/apis/apps/v1beta1/namespaces/{namespace}/controllerrevisions/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
