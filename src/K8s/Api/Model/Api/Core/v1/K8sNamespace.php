 ...
 * @Kubernetes\Operation("patch",path="/api/v1/namespaces/{name}",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/api/v1/namespaces/{name}/status",response="static::class")
