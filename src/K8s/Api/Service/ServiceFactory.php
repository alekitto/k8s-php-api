...
/**
 * This file was automatically generated by k8s/api-generator 0.12.0 for API version v1.28.13
 *
...
use K8s\Api\Service\AdmissionRegistration\v1alpha1\ValidatingAdmissionPolicyBindingService;
use K8s\Api\Service\AdmissionRegistration\v1alpha1\ValidatingAdmissionPolicyService;
...
use K8s\Api\Service\FlowControl\ApiServer\v1beta2\FlowSchemaService;
use K8s\Api\Service\FlowControl\ApiServer\v1beta2\PriorityLevelConfigurationService;
...
class ServiceFactory
{
    ...
    public function v1alpha1AdmissionregistrationValidatingAdmissionPolicy(): ValidatingAdmissionPolicyService
    {
    ...
    public function v1alpha1AdmissionregistrationValidatingAdmissionPolicyBinding(): ValidatingAdmissionPolicyBindingService
    {
    ...
    public function v1beta2FlowcontrolFlowSchema(): FlowSchemaService
    {
    ...
    public function v1beta2FlowcontrolPriorityLevelConfiguration(): PriorityLevelConfigurationService
    {
