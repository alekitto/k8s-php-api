 ...
 * @Kubernetes\Operation("delete",path="/apis/certificates.k8s.io/v1beta1/certificatesigningrequests/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
