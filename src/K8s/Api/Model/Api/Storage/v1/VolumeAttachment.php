 ...
 * @Kubernetes\Operation("patch",path="/apis/storage.k8s.io/v1/volumeattachments/{name}",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/apis/storage.k8s.io/v1/volumeattachments/{name}/status",response="static::class")
