 ...
 *
 * @Kubernetes\Kind("PodSchedulingList",group="resource.k8s.io",version="v1alpha1")
 *
 * @implements \IteratorAggregate<int, PodScheduling>
 */
class PodSchedulingList implements IteratorAggregate
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=PodScheduling::class,isRequired=true)
     * @var iterable|PodScheduling[]
     */
    protected $items;
     ...
     * @var string|null
     */
    protected $kind = 'PodSchedulingList';
    ...
    /**
     * @param iterable|PodScheduling[] $items
     */
    ...
    /**
     * @return ArrayIterator|iterable|PodScheduling[]
     */
     ...
     * @return static
     */
    public function addItems(PodScheduling $item)
    {
        if (!$this->items) {
