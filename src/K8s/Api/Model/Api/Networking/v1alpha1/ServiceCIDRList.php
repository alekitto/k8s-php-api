...
class ServiceCIDRList implements IteratorAggregate
{
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=ServiceCIDR::class,isRequired=true)
     ...
     * @var string|null
     */
    protected $kind = 'ServiceCIDRList';
     ...
     * @return static
     */
    public function addItems(ServiceCIDR $item)
    {
        if (!$this->items) {
