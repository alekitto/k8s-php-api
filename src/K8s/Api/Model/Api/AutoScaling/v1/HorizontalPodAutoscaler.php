 ...
 * @Kubernetes\Operation("deletecollection-all",path="/apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("patch",path="/apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers/{name}",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers/{name}/status",response="static::class")
