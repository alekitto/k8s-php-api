...
use K8s\Api\Model\Api\Batch\v1\JobSpec;
...
class JobTemplateSpec
{
     ...
     * to 10^5.
     *
     * This field is alpha-level and is only honored by servers that enable the IndexedJob feature gate.
     ...
     * This is an alpha field and requires the SuspendJob feature gate to be enabled; otherwise this field
