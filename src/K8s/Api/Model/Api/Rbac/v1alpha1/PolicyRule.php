...
class PolicyRule
{
     ...
     * only as the full, final step in the path This name is intentionally different than the internal type
     * so that the DefaultConvert works nicely and because the ordering may be different. Since
     * non-resource URLs are not namespaced, this field is only applicable for ClusterRoles referenced from
     * a ClusterRoleBinding. Rules can either apply to API resources (such as "pods" or "secrets") or
    ...
    /**
     * Verbs is a list of Verbs that apply to ALL the ResourceKinds and AttributeRestrictions contained in
