 ...
 * pods
 *
 * @Kubernetes\Kind("PodDisruptionBudget",group="policy",version="v1beta1")
 * @Kubernetes\Operation("get",path="/apis/policy/v1beta1/namespaces/{namespace}/poddisruptionbudgets/{name}",response="static::class")
 * @Kubernetes\Operation("get-status",path="/apis/policy/v1beta1/namespaces/{namespace}/poddisruptionbudgets/{name}/status",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/policy/v1beta1/namespaces/{namespace}/poddisruptionbudgets",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/policy/v1beta1/namespaces/{namespace}/poddisruptionbudgets/{name}",body="model",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch",path="/apis/policy/v1beta1/namespaces/{namespace}/poddisruptionbudgets",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("put",path="/apis/policy/v1beta1/namespaces/{namespace}/poddisruptionbudgets/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("put-status",path="/apis/policy/v1beta1/namespaces/{namespace}/poddisruptionbudgets/{name}/status",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection",path="/apis/policy/v1beta1/namespaces/{namespace}/poddisruptionbudgets",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/policy/v1beta1/poddisruptionbudgets",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/policy/v1beta1/namespaces/{namespace}/poddisruptionbudgets/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/apis/policy/v1beta1/namespaces/{namespace}/poddisruptionbudgets/{name}/status",body="patch",response="static::class")
 * @Kubernetes\Operation("list",path="/apis/policy/v1beta1/namespaces/{namespace}/poddisruptionbudgets",response="K8s\Api\Model\Api\Policy\v1beta1\PodDisruptionBudgetList")
 * @Kubernetes\Operation("list-all",path="/apis/policy/v1beta1/poddisruptionbudgets",response="K8s\Api\Model\Api\Policy\v1beta1\PodDisruptionBudgetList")
 */
