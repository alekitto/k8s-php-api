...
/**
 * DEPRECATED - This group version of StatefulSet is deprecated by apps/v1/StatefulSet. See the release
 * notes for more information. StatefulSet represents a set of pods with consistent identities.
 ...
 * identity.
 *
 * @Kubernetes\Kind("StatefulSet",group="apps",version="v1beta2")
 * @Kubernetes\Operation("get",path="/apis/apps/v1beta2/namespaces/{namespace}/statefulsets/{name}",response="static::class")
 * @Kubernetes\Operation("get-status",path="/apis/apps/v1beta2/namespaces/{namespace}/statefulsets/{name}/status",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/apps/v1beta2/namespaces/{namespace}/statefulsets",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/apps/v1beta2/namespaces/{namespace}/statefulsets/{name}",body="model",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch",path="/apis/apps/v1beta2/namespaces/{namespace}/statefulsets",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("put",path="/apis/apps/v1beta2/namespaces/{namespace}/statefulsets/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("put-status",path="/apis/apps/v1beta2/namespaces/{namespace}/statefulsets/{name}/status",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection",path="/apis/apps/v1beta2/namespaces/{namespace}/statefulsets",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/apps/v1beta2/statefulsets",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/apps/v1beta2/namespaces/{namespace}/statefulsets/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/apis/apps/v1beta2/namespaces/{namespace}/statefulsets/{name}/status",body="patch",response="static::class")
 * @Kubernetes\Operation("list",path="/apis/apps/v1beta2/namespaces/{namespace}/statefulsets",response="K8s\Api\Model\Api\Apps\v1beta2\StatefulSetList")
 * @Kubernetes\Operation("list-all",path="/apis/apps/v1beta2/statefulsets",response="K8s\Api\Model\Api\Apps\v1beta2\StatefulSetList")
 */
class StatefulSet
{
    /**
