 ...
 *
 * @Kubernetes\Kind("AuditSinkList",group="auditregistration.k8s.io",version="v1alpha1")
 *
 * @implements \IteratorAggregate<int, AuditSink>
 */
class AuditSinkList implements IteratorAggregate
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=AuditSink::class,isRequired=true)
     * @var iterable|AuditSink[]
     */
    ...
    /**
     * @param iterable|AuditSink[] $items
     */
    ...
    /**
     * @return ArrayIterator|iterable|AuditSink[]
     */
     ...
     * @return static
     */
    public function addItems(AuditSink $item)
    {
        if (!$this->items) {
