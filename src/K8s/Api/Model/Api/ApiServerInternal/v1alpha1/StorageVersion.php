 ...
 * @Kubernetes\Operation("patch",path="/apis/internal.apiserver.k8s.io/v1alpha1/storageversions/{name}",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/apis/internal.apiserver.k8s.io/v1alpha1/storageversions/{name}/status",response="static::class")
