...
class APIServiceService
{
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.15/#list-apiservice-v1-apiregistration-k8s-io
     */
     ...
     * @param array $query
     * @param callable|object|null $handler
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.15/#delete-collection-apiservice-v1-apiregistration-k8s-io
     */
    public function deleteApiRegistrationV1Collection(array $query = [], $handler = null): ?Status
    {
        $options['query'] = $query;
        $options['handler'] = $handler;
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.15/#create-apiservice-v1-apiregistration-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.15/#read-apiservice-v1-apiregistration-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.15/#delete-apiservice-v1-apiregistration-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.15/#patch-apiservice-v1-apiregistration-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.15/#put-apiservice-v1-apiregistration-k8s-io
     */
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.15/#watchlist-apiservice-v1-apiregistration-k8s-io
     */
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.15/#watch-apiservice-v1-apiregistration-k8s-io
     */
