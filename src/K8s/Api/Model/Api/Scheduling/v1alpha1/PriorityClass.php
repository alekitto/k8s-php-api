...
namespace K8s\Api\Model\Api\Scheduling\v1alpha1;
 ...
 * scheduling.k8s.io/v1/PriorityClass. PriorityClass defines mapping from a priority class name to the
 * priority integer value. The value can be any valid integer.
 *
 * @Kubernetes\Kind("PriorityClass",group="scheduling.k8s.io",version="v1alpha1")
 * @Kubernetes\Operation("get",path="/apis/scheduling.k8s.io/v1alpha1/priorityclasses/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/scheduling.k8s.io/v1alpha1/priorityclasses",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/scheduling.k8s.io/v1alpha1/priorityclasses/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("put",path="/apis/scheduling.k8s.io/v1alpha1/priorityclasses/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection-all",path="/apis/scheduling.k8s.io/v1alpha1/priorityclasses",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/scheduling.k8s.io/v1alpha1/priorityclasses",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/scheduling.k8s.io/v1alpha1/priorityclasses/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("list-all",path="/apis/scheduling.k8s.io/v1alpha1/priorityclasses",response="K8s\Api\Model\Api\Scheduling\v1alpha1\PriorityClassList")
 */
class PriorityClass
{
    /**
     ...
     * @var string|null
     */
    protected $apiVersion = 'scheduling.k8s.io/v1alpha1';
     ...
     * PreemptLowerPriority. Defaults to PreemptLowerPriority if unset. This field is alpha-level and is
     * only honored by servers that enable the NonPreemptingPriority feature.
     */
