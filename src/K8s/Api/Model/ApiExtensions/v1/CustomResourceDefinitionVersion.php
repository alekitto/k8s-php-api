...
class CustomResourceDefinitionVersion
{
    ...
    /**
     * @Kubernetes\Attribute("selectableFields",type="collection",model=SelectableField::class)
     ...
     */
    public function getSelectableFields(): ?iterable
    {
     ...
     * @return static
     */
    public function setSelectableFields(iterable $selectableFields)
    {
     ...
     * @return static
     */
    public function addSelectableFields(SelectableField $selectableField)
    {
