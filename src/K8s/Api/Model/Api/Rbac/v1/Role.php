 ...
 * @Kubernetes\Operation("deletecollection-all",path="/apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/roles",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("patch",path="/apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/roles/{name}",response="static::class")
