 ...
 * @Kubernetes\Operation("get",path="/apis/flowcontrol.apiserver.k8s.io/v1/prioritylevelconfigurations/{name}",response="static::class")
 * @Kubernetes\Operation("get-status",path="/apis/flowcontrol.apiserver.k8s.io/v1/prioritylevelconfigurations/{name}/status",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/flowcontrol.apiserver.k8s.io/v1/prioritylevelconfigurations",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/flowcontrol.apiserver.k8s.io/v1/prioritylevelconfigurations/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("put",path="/apis/flowcontrol.apiserver.k8s.io/v1/prioritylevelconfigurations/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("put-status",path="/apis/flowcontrol.apiserver.k8s.io/v1/prioritylevelconfigurations/{name}/status",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection-all",path="/apis/flowcontrol.apiserver.k8s.io/v1/prioritylevelconfigurations",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("patch",path="/apis/flowcontrol.apiserver.k8s.io/v1/prioritylevelconfigurations/{name}",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/apis/flowcontrol.apiserver.k8s.io/v1/prioritylevelconfigurations/{name}/status",response="static::class")
 * @Kubernetes\Operation("list-all",path="/apis/flowcontrol.apiserver.k8s.io/v1/prioritylevelconfigurations",response="K8s\Api\Model\Api\FlowControl\v1\PriorityLevelConfigurationList")
 */
class PriorityLevelConfiguration
{
     ...
     * @var string
     */
    protected $apiVersion = 'flowcontrol.apiserver.k8s.io/v1';
