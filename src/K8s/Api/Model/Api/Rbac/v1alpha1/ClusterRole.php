 ...
 * a RoleBinding or ClusterRoleBinding. Deprecated in v1.17 in favor of rbac.authorization.k8s.io/v1
 ...
 * @Kubernetes\Operation("delete",path="/apis/rbac.authorization.k8s.io/v1alpha1/clusterroles/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
