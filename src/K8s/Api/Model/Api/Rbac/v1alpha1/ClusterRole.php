 ...
 *
 * @Kubernetes\Kind("ClusterRole",group="rbac.authorization.k8s.io",version="v1alpha1")
 * @Kubernetes\Operation("get",path="/apis/rbac.authorization.k8s.io/v1alpha1/clusterroles/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/rbac.authorization.k8s.io/v1alpha1/clusterroles",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/rbac.authorization.k8s.io/v1alpha1/clusterroles/{name}",body="model",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("put",path="/apis/rbac.authorization.k8s.io/v1alpha1/clusterroles/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection-all",path="/apis/rbac.authorization.k8s.io/v1alpha1/clusterroles",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/rbac.authorization.k8s.io/v1alpha1/clusterroles",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/rbac.authorization.k8s.io/v1alpha1/clusterroles/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("list-all",path="/apis/rbac.authorization.k8s.io/v1alpha1/clusterroles",response="K8s\Api\Model\Api\Rbac\v1alpha1\ClusterRoleList")
 */
class ClusterRole
{
    /**
