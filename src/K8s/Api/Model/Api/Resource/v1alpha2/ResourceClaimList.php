...
class ResourceClaimList implements IteratorAggregate
{
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=ResourceClaim::class,isRequired=true)
     ...
     * @var string|null
     */
    protected $kind = 'ResourceClaimList';
     ...
     * @return static
     */
    public function addItems(ResourceClaim $item)
    {
        if (!$this->items) {
