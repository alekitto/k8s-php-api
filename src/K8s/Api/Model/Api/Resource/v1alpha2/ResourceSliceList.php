...
class ResourceSliceList implements IteratorAggregate
{
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=ResourceSlice::class,isRequired=true)
     ...
     * @var string|null
     */
    protected $kind = 'ResourceSliceList';
     ...
     * @return static
     */
    public function addItems(ResourceSlice $item)
    {
        if (!$this->items) {
