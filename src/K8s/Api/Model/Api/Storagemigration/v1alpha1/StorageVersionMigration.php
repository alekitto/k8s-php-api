 ...
 * @Kubernetes\Operation("get",path="/apis/storagemigration.k8s.io/v1alpha1/storageversionmigrations/{name}",response="static::class")
 * @Kubernetes\Operation("get-status",path="/apis/storagemigration.k8s.io/v1alpha1/storageversionmigrations/{name}/status",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/storagemigration.k8s.io/v1alpha1/storageversionmigrations",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/storagemigration.k8s.io/v1alpha1/storageversionmigrations/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("put",path="/apis/storagemigration.k8s.io/v1alpha1/storageversionmigrations/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("put-status",path="/apis/storagemigration.k8s.io/v1alpha1/storageversionmigrations/{name}/status",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection-all",path="/apis/storagemigration.k8s.io/v1alpha1/storageversionmigrations",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("patch",path="/apis/storagemigration.k8s.io/v1alpha1/storageversionmigrations/{name}",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/apis/storagemigration.k8s.io/v1alpha1/storageversionmigrations/{name}/status",response="static::class")
 * @Kubernetes\Operation("list-all",path="/apis/storagemigration.k8s.io/v1alpha1/storageversionmigrations",response="K8s\Api\Model\Api\Storagemigration\v1alpha1\StorageVersionMigrationList")
 */
class StorageVersionMigration
{
     ...
     * @var string
     */
    protected $apiVersion = 'storagemigration.k8s.io/v1alpha1';

    /**
     * @Kubernetes\Attribute("kind")
     * @var string
     */
    protected $kind = 'StorageVersionMigration';
    ...
    /**
     * @Kubernetes\Attribute("spec",type="model",model=StorageVersionMigrationSpec::class)
     * @var StorageVersionMigrationSpec
     */
    protected $spec;

    /**
     * @Kubernetes\Attribute("status",type="model",model=StorageVersionMigrationStatus::class)
     * @var StorageVersionMigrationStatus|null
     */
     ...
     */
    public function __construct(?string $name, GroupVersionResource $resource)
    {
    ...
    {
        return $this->status->getResourceVersion();
    }
     ...
     * @return static
     */
    public function setSpec(StorageVersionMigrationSpec $spec)
    {
        $this->spec = $spec;
     ...
     */
    public function getStatus(): ?StorageVersionMigrationStatus
    {
        return $this->status;
    }
     ...
     * @return static
     */
    public function setStatus(StorageVersionMigrationStatus $status)
    {
        $this->status = $status;
