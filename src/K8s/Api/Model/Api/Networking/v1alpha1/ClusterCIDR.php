 ...
 * @Kubernetes\Operation("patch",path="/apis/networking.k8s.io/v1alpha1/clustercidrs/{name}",response="static::class")
...
class ClusterCIDR
{
    ...
    /**
     * ipv6 defines an IPv6 IP block in CIDR notation(e.g. "2001:db8::/64"). At least one of ipv4 and ipv6
     * must be specified. This field is immutable.
     */
