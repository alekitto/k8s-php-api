 ...
 *
 * @Kubernetes\Kind("NetworkPolicy",group="extensions",version="v1beta1")
 * @Kubernetes\Operation("get",path="/apis/extensions/v1beta1/namespaces/{namespace}/networkpolicies/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/extensions/v1beta1/namespaces/{namespace}/networkpolicies",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/extensions/v1beta1/namespaces/{namespace}/networkpolicies/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch",path="/apis/extensions/v1beta1/namespaces/{namespace}/networkpolicies",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("put",path="/apis/extensions/v1beta1/namespaces/{namespace}/networkpolicies/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection",path="/apis/extensions/v1beta1/namespaces/{namespace}/networkpolicies",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/extensions/v1beta1/networkpolicies",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/extensions/v1beta1/namespaces/{namespace}/networkpolicies/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("list",path="/apis/extensions/v1beta1/namespaces/{namespace}/networkpolicies",response="K8s\Api\Model\Api\Extensions\v1beta1\NetworkPolicyList")
 * @Kubernetes\Operation("list-all",path="/apis/extensions/v1beta1/networkpolicies",response="K8s\Api\Model\Api\Extensions\v1beta1\NetworkPolicyList")
 */
class NetworkPolicy
{
    /**
     ...
     * no NetworkPolicies selecting the pod OR if the traffic source is the pod's local node, OR if the
     * traffic matches at least one ingress rule across all of the NetworkPolicy objects whose podSelector
     * matches the pod. If this field is empty then this NetworkPolicy does not allow any traffic (and
     ...
     * or Egress rules; policies that contain an Egress section are assumed to affect Egress, and all
     * policies (whether or not they contain an Ingress section) are assumed to affect Ingress. If you want
     * to write an egress-only policy, you must explicitly specify policyTypes [ "Egress" ]. Likewise, if
     * you want to write a policy that specifies that no egress is allowed, you must specify a policyTypes
     * value that include "Egress" (since such a policy would not include an Egress section and would
