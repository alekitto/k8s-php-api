 ...
 *
 * @Kubernetes\Kind("EndpointSlice",group="discovery.k8s.io",version="v1alpha1")
 * @Kubernetes\Operation("get",path="/apis/discovery.k8s.io/v1alpha1/namespaces/{namespace}/endpointslices/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/discovery.k8s.io/v1alpha1/namespaces/{namespace}/endpointslices",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/discovery.k8s.io/v1alpha1/namespaces/{namespace}/endpointslices/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch",path="/apis/discovery.k8s.io/v1alpha1/namespaces/{namespace}/endpointslices",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("put",path="/apis/discovery.k8s.io/v1alpha1/namespaces/{namespace}/endpointslices/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection",path="/apis/discovery.k8s.io/v1alpha1/namespaces/{namespace}/endpointslices",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/discovery.k8s.io/v1alpha1/endpointslices",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/discovery.k8s.io/v1alpha1/namespaces/{namespace}/endpointslices/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("list",path="/apis/discovery.k8s.io/v1alpha1/namespaces/{namespace}/endpointslices",response="K8s\Api\Model\Api\Discovery\v1alpha1\EndpointSliceList")
 * @Kubernetes\Operation("list-all",path="/apis/discovery.k8s.io/v1alpha1/endpointslices",response="K8s\Api\Model\Api\Discovery\v1alpha1\EndpointSliceList")
 */
class EndpointSlice
{
    /**
     * @Kubernetes\Attribute("addressType")
     * @var string|null
     */
     ...
     * @var string|null
     */
    protected $apiVersion = 'discovery.k8s.io/v1alpha1';
     ...
     */
    public function __construct(?string $name, iterable $endpoints)
    {
     ...
     * must be the same type. Default is IP
     */
