 ...
 * @Kubernetes\Operation("delete",path="/apis/admissionregistration.k8s.io/v1alpha1/initializerconfigurations/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
