...
class ClusterRoleBindingService
{
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#list-clusterrolebinding-v1-rbac-authorization-k8s-io
     */
     ...
     * @param array $query
     * @param callable|null $handler
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#delete-collection-clusterrolebinding-v1-rbac-authorization-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#create-clusterrolebinding-v1-rbac-authorization-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#read-clusterrolebinding-v1-rbac-authorization-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#delete-clusterrolebinding-v1-rbac-authorization-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#patch-clusterrolebinding-v1-rbac-authorization-k8s-io
     */
    public function patchRbacAuthorizationV1(string $name, array $patch, array $query = []): ClusterRoleBinding
    {
        $options['query'] = $query;
        $options['body'] = $patch;
        $options['model'] = ClusterRoleBinding::class;
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#put-clusterrolebinding-v1-rbac-authorization-k8s-io
     */
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#watchlist-clusterrolebinding-v1-rbac-authorization-k8s-io
     */
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#watch-clusterrolebinding-v1-rbac-authorization-k8s-io
     */
