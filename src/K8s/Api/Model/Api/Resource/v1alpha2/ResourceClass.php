 ...
 * @Kubernetes\Operation("watch-all",path="/apis/resource.k8s.io/v1alpha2/resourceclasses",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/resource.k8s.io/v1alpha2/resourceclasses/{name}",body="patch",response="static::class")
