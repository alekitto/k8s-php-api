 ...
 * @Kubernetes\Operation("delete",path="/apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers/{name}",body="model",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
