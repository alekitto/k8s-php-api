 ...
 * @Kubernetes\Operation("patch",path="/apis/admissionregistration.k8s.io/v1alpha1/validatingadmissionpolicies/{name}",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/apis/admissionregistration.k8s.io/v1alpha1/validatingadmissionpolicies/{name}/status",response="static::class")
