 ...
 * @Kubernetes\Operation("deletecollection-all",path="/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/podschedulingcontexts",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("patch",path="/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/podschedulingcontexts/{name}",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/podschedulingcontexts/{name}/status",response="static::class")
