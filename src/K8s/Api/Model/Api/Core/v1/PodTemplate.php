 ...
 * @Kubernetes\Operation("deletecollection-all",path="/api/v1/namespaces/{namespace}/podtemplates",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("patch",path="/api/v1/namespaces/{namespace}/podtemplates/{name}",response="static::class")
