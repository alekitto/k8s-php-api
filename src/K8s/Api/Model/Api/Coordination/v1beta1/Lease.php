 ...
 * @Kubernetes\Operation("delete",path="/apis/coordination.k8s.io/v1beta1/namespaces/{namespace}/leases/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
