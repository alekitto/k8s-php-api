...
{
    /**
     * @Kubernetes\Attribute("appArmorProfile",type="model",model=AppArmorProfile::class)
     * @var AppArmorProfile|null
     */
    protected $appArmorProfile = null;
     ...
     */
    public function getAppArmorProfile(): ?AppArmorProfile
    {
     ...
     * @return static
     */
    public function setAppArmorProfile(AppArmorProfile $appArmorProfile)
    {
