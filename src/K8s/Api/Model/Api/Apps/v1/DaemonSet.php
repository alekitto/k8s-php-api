 ...
 * @Kubernetes\Operation("deletecollection-all",path="/apis/apps/v1/namespaces/{namespace}/daemonsets",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("patch",path="/apis/apps/v1/namespaces/{namespace}/daemonsets/{name}",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/apis/apps/v1/namespaces/{namespace}/daemonsets/{name}/status",response="static::class")
