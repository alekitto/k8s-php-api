 ...
 * @Kubernetes\Operation("watch-all",path="/apis/networking.k8s.io/v1alpha1/ipaddresses",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/networking.k8s.io/v1alpha1/ipaddresses/{name}",body="patch",response="static::class")
