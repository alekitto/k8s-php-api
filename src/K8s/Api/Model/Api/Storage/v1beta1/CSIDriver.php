 ...
 * the cluster. CSI drivers do not need to create the CSIDriver object directly. Instead they may use
 * the cluster-driver-registrar sidecar container. When deployed with a CSI driver it automatically
 * creates a CSIDriver object representing the driver. Kubernetes attach detach controller uses this
 * object to determine whether attach is required. Kubelet uses this object to determine whether pod
 * information needs to be passed on mount. CSIDriver objects are non-namespaced.
 *
 * @Kubernetes\Kind("CSIDriver",group="storage.k8s.io",version="v1beta1")
 * @Kubernetes\Operation("get",path="/apis/storage.k8s.io/v1beta1/csidrivers/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/storage.k8s.io/v1beta1/csidrivers",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/storage.k8s.io/v1beta1/csidrivers/{name}",response="static::class")
 * @Kubernetes\Operation("put",path="/apis/storage.k8s.io/v1beta1/csidrivers/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection-all",path="/apis/storage.k8s.io/v1beta1/csidrivers",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/storage.k8s.io/v1beta1/csidrivers",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/storage.k8s.io/v1beta1/csidrivers/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("list-all",path="/apis/storage.k8s.io/v1beta1/csidrivers",response="K8s\Api\Model\Api\Storage\v1beta1\CSIDriverList")
 */
class CSIDriver
{
    /**
     ...
     * This field is immutable.
     *
     * This is a beta field and only available when the CSIStorageCapacity feature is enabled. The default
     * is false.
     */
