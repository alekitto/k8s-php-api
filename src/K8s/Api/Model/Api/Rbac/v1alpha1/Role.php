 ...
 * RoleBinding. Deprecated in v1.17 in favor of rbac.authorization.k8s.io/v1 Role, and will no longer
 * be served in v1.22.
 *
 ...
 * @Kubernetes\Operation("delete",path="/apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{namespace}/roles/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
