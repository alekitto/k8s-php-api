 ...
 * @Kubernetes\Operation("deletecollection-all",path="/apis/policy/v1/namespaces/{namespace}/poddisruptionbudgets",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("patch",path="/apis/policy/v1/namespaces/{namespace}/poddisruptionbudgets/{name}",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/apis/policy/v1/namespaces/{namespace}/poddisruptionbudgets/{name}/status",response="static::class")
