 ...
 * @Kubernetes\Operation("patch",path="/apis/flowcontrol.apiserver.k8s.io/v1beta2/prioritylevelconfigurations/{name}",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/apis/flowcontrol.apiserver.k8s.io/v1beta2/prioritylevelconfigurations/{name}/status",response="static::class")
