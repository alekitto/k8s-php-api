...
class Endpoint
{
     ...
     * corresponding EndpointSlice addressType field. This allows for cases like dual-stack (IPv4 and IPv6)
     * networking. Consumers (e.g. kube-proxy) must handle different types of addresses in the context of
     ...
     * considered fungible (e.g. multiple A values in DNS). Must pass DNS Label (RFC 1123) validation.
     */
