 ...
 *
 * @Kubernetes\Kind("AuditSink",group="auditregistration.k8s.io",version="v1alpha1")
 * @Kubernetes\Operation("get",path="/apis/auditregistration.k8s.io/v1alpha1/auditsinks/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/auditregistration.k8s.io/v1alpha1/auditsinks",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/auditregistration.k8s.io/v1alpha1/auditsinks/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("put",path="/apis/auditregistration.k8s.io/v1alpha1/auditsinks/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection-all",path="/apis/auditregistration.k8s.io/v1alpha1/auditsinks",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/auditregistration.k8s.io/v1alpha1/auditsinks",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/auditregistration.k8s.io/v1alpha1/auditsinks/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("list-all",path="/apis/auditregistration.k8s.io/v1alpha1/auditsinks",response="K8s\Api\Model\Api\Auditregistration\v1alpha1\AuditSinkList")
 */
class AuditSink
{
    /**
     ...
     * @var string
     */
    protected $apiVersion = 'auditregistration.k8s.io/v1alpha1';

    /**
     * @Kubernetes\Attribute("kind")
     * @var string
     */
    protected $kind = 'AuditSink';
    ...
    /**
     * @Kubernetes\Attribute("spec",type="model",model=AuditSinkSpec::class)
     * @var AuditSinkSpec
     */
    protected $spec = null;
     ...
     */
    public function __construct(?string $name, Policy $policy, Webhook $webhook)
    {
        $this->metadata = new ObjectMeta($name);
        $this->spec = new AuditSinkSpec($policy, $webhook);
    }
     ...
     * @return static
     */
    public function setSpec(AuditSinkSpec $spec)
    {
        $this->spec = $spec;
