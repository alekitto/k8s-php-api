 ...
 * @Kubernetes\Operation("get",path="/apis/admissionregistration.k8s.io/v1/validatingadmissionpolicies/{name}",response="static::class")
 * @Kubernetes\Operation("get-status",path="/apis/admissionregistration.k8s.io/v1/validatingadmissionpolicies/{name}/status",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/admissionregistration.k8s.io/v1/validatingadmissionpolicies",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/admissionregistration.k8s.io/v1/validatingadmissionpolicies/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("put",path="/apis/admissionregistration.k8s.io/v1/validatingadmissionpolicies/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("put-status",path="/apis/admissionregistration.k8s.io/v1/validatingadmissionpolicies/{name}/status",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection-all",path="/apis/admissionregistration.k8s.io/v1/validatingadmissionpolicies",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("patch",path="/apis/admissionregistration.k8s.io/v1/validatingadmissionpolicies/{name}",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/apis/admissionregistration.k8s.io/v1/validatingadmissionpolicies/{name}/status",response="static::class")
 * @Kubernetes\Operation("list-all",path="/apis/admissionregistration.k8s.io/v1/validatingadmissionpolicies",response="K8s\Api\Model\Api\AdmissionRegistration\v1\ValidatingAdmissionPolicyList")
 */
