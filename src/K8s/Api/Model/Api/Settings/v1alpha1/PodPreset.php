 ...
 *
 * @Kubernetes\Kind("PodPreset",group="settings.k8s.io",version="v1alpha1")
 * @Kubernetes\Operation("get",path="/apis/settings.k8s.io/v1alpha1/namespaces/{namespace}/podpresets/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/settings.k8s.io/v1alpha1/namespaces/{namespace}/podpresets",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/settings.k8s.io/v1alpha1/namespaces/{namespace}/podpresets/{name}",body="model",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch",path="/apis/settings.k8s.io/v1alpha1/namespaces/{namespace}/podpresets",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("put",path="/apis/settings.k8s.io/v1alpha1/namespaces/{namespace}/podpresets/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection",path="/apis/settings.k8s.io/v1alpha1/namespaces/{namespace}/podpresets",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/settings.k8s.io/v1alpha1/podpresets",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/settings.k8s.io/v1alpha1/namespaces/{namespace}/podpresets/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("list",path="/apis/settings.k8s.io/v1alpha1/namespaces/{namespace}/podpresets",response="K8s\Api\Model\Api\Settings\v1alpha1\PodPresetList")
 * @Kubernetes\Operation("list-all",path="/apis/settings.k8s.io/v1alpha1/podpresets",response="K8s\Api\Model\Api\Settings\v1alpha1\PodPresetList")
 */
class PodPreset
{
    /**
     ...
     * @var string
     */
    protected $apiVersion = 'settings.k8s.io/v1alpha1';

    /**
     * @Kubernetes\Attribute("kind")
     * @var string
     */
    protected $kind = 'PodPreset';
    ...
    /**
     * @Kubernetes\Attribute("spec",type="model",model=PodPresetSpec::class)
     * @var PodPresetSpec
     */
    protected $spec;
    ...
    {
        return $this->spec->getVolumeMounts();
    }
    ...
    {
        $this->spec->setVolumeMounts($volumeMounts);
    ...
    {
        $this->spec->addVolumeMounts($volumeMount);
    ...
    public function getSpec(): PodPresetSpec
    {
        return $this->spec;
    }
     ...
     * @return static
     */
    public function setSpec(PodPresetSpec $spec)
    {
        $this->spec = $spec;
