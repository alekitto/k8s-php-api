...
class CSIDriverSpec
{
     ...
     */
    protected $tokenRequests;

    /**
     * @Kubernetes\Attribute("volumeLifecycleModes")
     * @var string[]|null
     */
    protected $volumeLifecycleModes;
