...
class ResourceClassList implements IteratorAggregate
{
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=ResourceClass::class,isRequired=true)
     ...
     * @var string|null
     */
    protected $kind = 'ResourceClassList';
     ...
     * @return static
     */
    public function addItems(ResourceClass $item)
    {
        if (!$this->items) {
