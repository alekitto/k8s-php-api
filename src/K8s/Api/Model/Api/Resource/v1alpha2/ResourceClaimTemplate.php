 ...
 * @Kubernetes\Operation("get",path="/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaimtemplates/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaimtemplates",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaimtemplates/{name}",response="static::class")
 * @Kubernetes\Operation("watch",path="/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaimtemplates",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("put",path="/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaimtemplates/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection",path="/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaimtemplates",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/resource.k8s.io/v1alpha2/resourceclaimtemplates",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaimtemplates/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("list",path="/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaimtemplates",response="K8s\Api\Model\Api\Resource\v1alpha2\ResourceClaimTemplateList")
 * @Kubernetes\Operation("list-all",path="/apis/resource.k8s.io/v1alpha2/resourceclaimtemplates",response="K8s\Api\Model\Api\Resource\v1alpha2\ResourceClaimTemplateList")
 */
