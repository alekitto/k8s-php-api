 ...
 * @Kubernetes\Operation("patch",path="/apis/apiextensions.k8s.io/v1/customresourcedefinitions/{name}",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/apis/apiextensions.k8s.io/v1/customresourcedefinitions/{name}/status",response="static::class")
