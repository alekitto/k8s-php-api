 ...
 * @Kubernetes\Operation("delete",path="/apis/extensions/v1beta1/namespaces/{namespace}/replicasets/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
