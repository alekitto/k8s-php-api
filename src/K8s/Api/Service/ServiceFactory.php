...
use K8s\Api\Service\Auditregistration\v1alpha1\AuditSinkService;
...
use K8s\Api\Service\Discovery\v1alpha1\EndpointSliceService;
...
use K8s\Api\Service\Node\v1alpha1\RuntimeClassService;
...
use K8s\Api\Service\Storage\v1beta1\CSIDriverService;
use K8s\Api\Service\Storage\v1beta1\CSINodeService;
...
class ServiceFactory
{
    ...
    public function v1alpha1AuditregistrationAuditSink(): AuditSinkService
    {
        return new AuditSinkService($this->api);
    }
    ...
    public function v1alpha1DiscoveryEndpointSlice(): EndpointSliceService
    {
    ...
    public function v1alpha1NodeRuntimeClass(): RuntimeClassService
    {
    ...
    public function v1beta1StorageCSIDriver(): CSIDriverService
    {
        return new CSIDriverService($this->api);
    }

    public function v1beta1StorageCSINode(): CSINodeService
    {
