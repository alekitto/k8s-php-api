 ...
 * @Kubernetes\Operation("delete",path="/api/v1/namespaces/{namespace}/secrets/{name}",body="model",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
...
class Secret
{
     ...
     * convenience method. All keys and values are merged into the data field on write, overwriting any
