 ...
 * @Kubernetes\Operation("delete",path="/apis/scheduling.k8s.io/v1alpha1/priorityclasses/{name}",body="model",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
