 ...
 * @Kubernetes\Operation("get",path="/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaimparameters/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaimparameters",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaimparameters/{name}",response="static::class")
 * @Kubernetes\Operation("put",path="/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaimparameters/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection-all",path="/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaimparameters",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("patch",path="/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaimparameters/{name}",response="static::class")
 * @Kubernetes\Operation("list",path="/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaimparameters",response="K8s\Api\Model\Api\Resource\v1alpha2\ResourceClaimParametersList")
 * @Kubernetes\Operation("list-all",path="/apis/resource.k8s.io/v1alpha2/resourceclaimparameters",response="K8s\Api\Model\Api\Resource\v1alpha2\ResourceClaimParametersList")
 */
class ResourceClaimParameters
{
    ...
    /**
     * @Kubernetes\Attribute("driverRequests",type="collection",model=DriverRequests::class)
     * @var iterable|DriverRequests[]|null
     */
    protected $driverRequests = null;

    /**
     * @Kubernetes\Attribute("generatedFrom",type="model",model=ResourceClaimParametersReference::class)
     ...
     * @var string|null
     */
    protected $kind = 'ResourceClaimParameters';
     ...
     */
    public function getDriverRequests(): ?iterable
    {
     ...
     * @return static
     */
    public function setDriverRequests(iterable $driverRequests)
    {
     ...
     * @return static
     */
    public function addDriverRequests(DriverRequests $driverRequest)
    {
     ...
     */
    public function getGeneratedFrom(): ?ResourceClaimParametersReference
    {
     ...
     * @return static
     */
    public function setGeneratedFrom(ResourceClaimParametersReference $generatedFrom)
    {
