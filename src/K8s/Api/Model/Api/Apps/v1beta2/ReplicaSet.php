...
/**
 * DEPRECATED - This group version of ReplicaSet is deprecated by apps/v1/ReplicaSet. See the release
 * notes for more information. ReplicaSet ensures that a specified number of pod replicas are running
 * at any given time.
 *
 * @Kubernetes\Kind("ReplicaSet",group="apps",version="v1beta2")
 * @Kubernetes\Operation("get",path="/apis/apps/v1beta2/namespaces/{namespace}/replicasets/{name}",response="static::class")
 * @Kubernetes\Operation("get-status",path="/apis/apps/v1beta2/namespaces/{namespace}/replicasets/{name}/status",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/apps/v1beta2/namespaces/{namespace}/replicasets",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/apps/v1beta2/namespaces/{namespace}/replicasets/{name}",body="model",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch",path="/apis/apps/v1beta2/namespaces/{namespace}/replicasets",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("put",path="/apis/apps/v1beta2/namespaces/{namespace}/replicasets/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("put-status",path="/apis/apps/v1beta2/namespaces/{namespace}/replicasets/{name}/status",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection",path="/apis/apps/v1beta2/namespaces/{namespace}/replicasets",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/apps/v1beta2/replicasets",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/apps/v1beta2/namespaces/{namespace}/replicasets/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/apis/apps/v1beta2/namespaces/{namespace}/replicasets/{name}/status",body="patch",response="static::class")
 * @Kubernetes\Operation("list",path="/apis/apps/v1beta2/namespaces/{namespace}/replicasets",response="K8s\Api\Model\Api\Apps\v1beta2\ReplicaSetList")
 * @Kubernetes\Operation("list-all",path="/apis/apps/v1beta2/replicasets",response="K8s\Api\Model\Api\Apps\v1beta2\ReplicaSetList")
 */
class ReplicaSet
{
    /**
