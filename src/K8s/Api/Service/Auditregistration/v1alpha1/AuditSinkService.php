...
class AuditSinkService
{
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#list-auditsink-v1alpha1-auditregistration-k8s-io
     */
     ...
     * @param array $query
     * @param callable|null $handler
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#delete-collection-auditsink-v1alpha1-auditregistration-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#create-auditsink-v1alpha1-auditregistration-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#read-auditsink-v1alpha1-auditregistration-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#delete-auditsink-v1alpha1-auditregistration-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#patch-auditsink-v1alpha1-auditregistration-k8s-io
     */
    public function patchAuditregistrationV1alpha1(string $name, array $patch, array $query = []): AuditSink
    {
        $options['query'] = $query;
        $options['body'] = $patch;
        $options['model'] = AuditSink::class;
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#put-auditsink-v1alpha1-auditregistration-k8s-io
     */
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#watchlist-auditsink-v1alpha1-auditregistration-k8s-io
     */
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#watch-auditsink-v1alpha1-auditregistration-k8s-io
     */
