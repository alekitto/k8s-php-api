 ...
 *
 * @Kubernetes\Kind("DaemonSet",group="extensions",version="v1beta1")
 * @Kubernetes\Operation("get",path="/apis/extensions/v1beta1/namespaces/{namespace}/daemonsets/{name}",response="static::class")
 * @Kubernetes\Operation("get-status",path="/apis/extensions/v1beta1/namespaces/{namespace}/daemonsets/{name}/status",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/extensions/v1beta1/namespaces/{namespace}/daemonsets",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/extensions/v1beta1/namespaces/{namespace}/daemonsets/{name}",body="model",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch",path="/apis/extensions/v1beta1/namespaces/{namespace}/daemonsets",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("put",path="/apis/extensions/v1beta1/namespaces/{namespace}/daemonsets/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("put-status",path="/apis/extensions/v1beta1/namespaces/{namespace}/daemonsets/{name}/status",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection",path="/apis/extensions/v1beta1/namespaces/{namespace}/daemonsets",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/extensions/v1beta1/daemonsets",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/extensions/v1beta1/namespaces/{namespace}/daemonsets/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/apis/extensions/v1beta1/namespaces/{namespace}/daemonsets/{name}/status",body="patch",response="static::class")
 * @Kubernetes\Operation("list",path="/apis/extensions/v1beta1/namespaces/{namespace}/daemonsets",response="K8s\Api\Model\Api\Extensions\v1beta1\DaemonSetList")
 * @Kubernetes\Operation("list-all",path="/apis/extensions/v1beta1/daemonsets",response="K8s\Api\Model\Api\Extensions\v1beta1\DaemonSetList")
 */
class DaemonSet
{
    /**
    ...
    public function __construct(?string $name, PodTemplateSpec $template)
    {
        ...
        $this->spec = new DaemonSetSpec($template);
    }
    ...
    /**
     * A label query over pods that are managed by the daemon set. Must match in order to be controlled. If
    ...
    /**
     * DEPRECATED. A sequence number representing a specific generation of the template. Populated by the
     * system. It can be set only during the creation.
     */
    public function getTemplateGeneration(): ?int
    {
        return $this->spec->getTemplateGeneration();
    }
     ...
     * @return static
     */
    public function setTemplateGeneration(int $templateGeneration)
    {
        $this->spec->setTemplateGeneration($templateGeneration);
