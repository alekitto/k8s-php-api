 ...
 * @Kubernetes\Operation("get",path="/apis/flowcontrol.apiserver.k8s.io/v1beta3/flowschemas/{name}",response="static::class")
 * @Kubernetes\Operation("get-status",path="/apis/flowcontrol.apiserver.k8s.io/v1beta3/flowschemas/{name}/status",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/flowcontrol.apiserver.k8s.io/v1beta3/flowschemas",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/flowcontrol.apiserver.k8s.io/v1beta3/flowschemas/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("put",path="/apis/flowcontrol.apiserver.k8s.io/v1beta3/flowschemas/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("put-status",path="/apis/flowcontrol.apiserver.k8s.io/v1beta3/flowschemas/{name}/status",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection-all",path="/apis/flowcontrol.apiserver.k8s.io/v1beta3/flowschemas",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/flowcontrol.apiserver.k8s.io/v1beta3/flowschemas",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/flowcontrol.apiserver.k8s.io/v1beta3/flowschemas/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/apis/flowcontrol.apiserver.k8s.io/v1beta3/flowschemas/{name}/status",body="patch",response="static::class")
 * @Kubernetes\Operation("list-all",path="/apis/flowcontrol.apiserver.k8s.io/v1beta3/flowschemas",response="K8s\Api\Model\Api\FlowControl\v1beta3\FlowSchemaList")
 */
class FlowSchema
{
    /**
