...
class NetworkPolicyService
{
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.16/#list-networkpolicy-v1beta1-extensions
     */
    public function listNamespaced(array $query = [], $handler = null): ?NetworkPolicyList
    {
        $options['query'] = $query;
        $options['method'] = 'get';
     ...
     * @param array $query
     * @param callable|object|null $handler
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.16/#delete-collection-networkpolicy-v1beta1-extensions
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.16/#create-networkpolicy-v1beta1-extensions
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.16/#read-networkpolicy-v1beta1-extensions
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.16/#delete-networkpolicy-v1beta1-extensions
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.16/#patch-networkpolicy-v1beta1-extensions
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.16/#put-networkpolicy-v1beta1-extensions
     */
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.16/#list-networkpolicy-v1beta1-extensions
     */
    public function listForAllNamespaces(array $query = [], $handler = null): ?NetworkPolicyList
    {
        $options['query'] = $query;
        $options['method'] = 'get';
        $options['handler'] = $handler;
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.16/#watchlist-networkpolicy-v1beta1-extensions
     */
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.16/#watch-networkpolicy-v1beta1-extensions
     */
