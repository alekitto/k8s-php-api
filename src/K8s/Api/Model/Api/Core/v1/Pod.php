 ...
 * @Kubernetes\Operation("deletecollection-all",path="/api/v1/namespaces/{namespace}/pods",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("patch",path="/api/v1/namespaces/{namespace}/pods/{name}",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/api/v1/namespaces/{namespace}/pods/{name}/status",response="static::class")
...
class Pod
{
     ...
     * @return static
     */
    public function addResourceClaims(PodResourceClaim $resourceClaim)
    {
     ...
     */
    public function getSchedulingGates(): ?iterable
    {
     ...
     * @return static
     */
    public function setSchedulingGates(iterable $schedulingGates)
    {
     ...
     * @return static
     */
    public function addSchedulingGates(PodSchedulingGate $schedulingGate)
    {
     ...
     */
    public function getHostIPs(): ?iterable
    {
        return $this->status->getHostIPs();
    }
     ...
     */
    public function getResourceClaimStatuses(): ?iterable
    {
        return $this->status->getResourceClaimStatuses();
    }
