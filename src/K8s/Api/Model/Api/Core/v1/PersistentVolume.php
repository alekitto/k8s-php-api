 ...
 * @Kubernetes\Operation("delete",path="/api/v1/persistentvolumes/{name}",body="model",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
...
class PersistentVolume
{
     ...
     * into the pod More info: https://releases.k8s.io/HEAD/examples/volumes/storageos/README.md
     */
     ...
     * raw block state. Value of Filesystem is implied when not included in spec. This is an alpha feature
