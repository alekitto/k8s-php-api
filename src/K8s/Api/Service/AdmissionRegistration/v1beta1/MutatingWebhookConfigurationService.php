...
class MutatingWebhookConfigurationService
{
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.18/#list-mutatingwebhookconfiguration-v1beta1-admissionregistration-k8s-io
     */
    public function listAdmissionRegistrationV1beta1(array $query = [], $handler = null): ?MutatingWebhookConfigurationList
    {
        $options['query'] = $query;
        $options['method'] = 'get';
     ...
     * @param array $query
     * @param callable|object|null $handler
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.18/#delete-collection-mutatingwebhookconfiguration-v1beta1-admissionregistration-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.18/#create-mutatingwebhookconfiguration-v1beta1-admissionregistration-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.18/#read-mutatingwebhookconfiguration-v1beta1-admissionregistration-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.18/#delete-mutatingwebhookconfiguration-v1beta1-admissionregistration-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.18/#patch-mutatingwebhookconfiguration-v1beta1-admissionregistration-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.18/#put-mutatingwebhookconfiguration-v1beta1-admissionregistration-k8s-io
     */
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.18/#watchlist-mutatingwebhookconfiguration-v1beta1-admissionregistration-k8s-io
     */
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.18/#watch-mutatingwebhookconfiguration-v1beta1-admissionregistration-k8s-io
     */
