 ...
 * @Kubernetes\Operation("get",path="/apis/resource.k8s.io/v1alpha2/resourceslices/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/resource.k8s.io/v1alpha2/resourceslices",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/resource.k8s.io/v1alpha2/resourceslices/{name}",response="static::class")
 * @Kubernetes\Operation("put",path="/apis/resource.k8s.io/v1alpha2/resourceslices/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection-all",path="/apis/resource.k8s.io/v1alpha2/resourceslices",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("patch",path="/apis/resource.k8s.io/v1alpha2/resourceslices/{name}",response="static::class")
 * @Kubernetes\Operation("list-all",path="/apis/resource.k8s.io/v1alpha2/resourceslices",response="K8s\Api\Model\Api\Resource\v1alpha2\ResourceSliceList")
 */
class ResourceSlice
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("namedResources",type="model",model=NamedResourcesResources::class)
     * @var NamedResourcesResources|null
     */
     ...
     */
    public function getNamedResources(): ?NamedResourcesResources
    {
     ...
     * @return static
     */
    public function setNamedResources(NamedResourcesResources $namedResources)
    {
