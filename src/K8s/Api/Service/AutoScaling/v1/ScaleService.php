...
class ScaleService
{
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#read-scale-v1-autoscaling
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#patch-scale-v1-autoscaling
     */
    public function patchCoreV1NamespacedReplicationController(string $name, array $query = []): Scale
    {
        $options['query'] = $query;
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#put-scale-v1-autoscaling
     */
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#patch-scale-v1-autoscaling
     */
    public function patchAppsV1NamespacedDeployment(string $name, array $query = []): Scale
    {
        $options['query'] = $query;
        $options['method'] = 'patch';
        $options['model'] = Scale::class;
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#patch-scale-v1-autoscaling
     */
    public function patchAppsV1NamespacedReplicaSet(string $name, array $query = []): Scale
    {
        $options['query'] = $query;
        $options['method'] = 'patch';
        $options['model'] = Scale::class;
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#patch-scale-v1-autoscaling
     */
    public function patchAppsV1NamespacedStatefulSet(string $name, array $query = []): Scale
    {
        $options['query'] = $query;
        $options['method'] = 'patch';
        $options['model'] = Scale::class;
