 ...
 * @Kubernetes\Operation("delete",path="/apis/autoscaling/v2beta2/namespaces/{namespace}/horizontalpodautoscalers/{name}",body="model",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
