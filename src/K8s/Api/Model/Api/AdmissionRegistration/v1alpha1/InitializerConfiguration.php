 ...
 *
 * @Kubernetes\Kind("InitializerConfiguration",group="admissionregistration.k8s.io",version="v1alpha1")
 * @Kubernetes\Operation("get",path="/apis/admissionregistration.k8s.io/v1alpha1/initializerconfigurations/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/admissionregistration.k8s.io/v1alpha1/initializerconfigurations",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/admissionregistration.k8s.io/v1alpha1/initializerconfigurations/{name}",body="model",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("put",path="/apis/admissionregistration.k8s.io/v1alpha1/initializerconfigurations/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection-all",path="/apis/admissionregistration.k8s.io/v1alpha1/initializerconfigurations",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/admissionregistration.k8s.io/v1alpha1/initializerconfigurations",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/admissionregistration.k8s.io/v1alpha1/initializerconfigurations/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("list-all",path="/apis/admissionregistration.k8s.io/v1alpha1/initializerconfigurations",response="K8s\Api\Model\Api\AdmissionRegistration\v1alpha1\InitializerConfigurationList")
 */
class InitializerConfiguration
{
    ...
    /**
     * @Kubernetes\Attribute("initializers",type="collection",model=Initializer::class)
     * @var iterable|Initializer[]|null
     */
     ...
     * @var string|null
     */
    protected $kind = 'InitializerConfiguration';
    ...
    /**
     * Initializers is a list of resources and their default initializers Order-sensitive. When merging
     * multiple InitializerConfigurations, we sort the initializers from different
     ...
     * @return static
     */
    public function setInitializers(iterable $initializers)
    {
     ...
     * @return static
     */
    public function addInitializers(Initializer $initializer)
    {
        if (!$this->initializers) {
            $this->initializers = new Collection();
        }
