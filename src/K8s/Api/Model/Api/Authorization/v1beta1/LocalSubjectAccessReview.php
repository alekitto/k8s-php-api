 ...
 *
 * @Kubernetes\Kind("LocalSubjectAccessReview",group="authorization.k8s.io",version="v1beta1")
 * @Kubernetes\Operation("post",path="/apis/authorization.k8s.io/v1beta1/namespaces/{namespace}/localsubjectaccessreviews",body="model",response="static::class")
 */
class LocalSubjectAccessReview
{
     ...
     * @var string
     */
    protected $apiVersion = 'authorization.k8s.io/v1beta1';
