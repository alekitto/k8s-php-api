...
class RoleService
{
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.18/#list-role-v1beta1-rbac-authorization-k8s-io
     */
    public function listRbacAuthorizationV1beta1Namespaced(array $query = [], ?callable $handler = null): ?RoleList
    {
        $options['query'] = $query;
     ...
     * @param array $query
     * @param callable|null $handler
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.18/#delete-collection-role-v1beta1-rbac-authorization-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.18/#create-role-v1beta1-rbac-authorization-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.18/#read-role-v1beta1-rbac-authorization-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.18/#delete-role-v1beta1-rbac-authorization-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.18/#patch-role-v1beta1-rbac-authorization-k8s-io
     */
    public function patchRbacAuthorizationV1beta1Namespaced(string $name, array $patch, array $query = []): Role
    {
        $options['query'] = $query;
        $options['body'] = $patch;
        $options['model'] = Role::class;
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.18/#put-role-v1beta1-rbac-authorization-k8s-io
     */
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.18/#list-role-v1beta1-rbac-authorization-k8s-io
     */
    public function listRbacAuthorizationV1beta1ForAllNamespaces(array $query = [], ?callable $handler = null): ?RoleList
    {
        $options['query'] = $query;
        $options['handler'] = $handler;
        $options['model'] = RoleList::class;
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.18/#watchlist-role-v1beta1-rbac-authorization-k8s-io
     */
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.18/#watch-role-v1beta1-rbac-authorization-k8s-io
     */
