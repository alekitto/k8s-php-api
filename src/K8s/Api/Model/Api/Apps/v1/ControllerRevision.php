 ...
 * @Kubernetes\Operation("deletecollection-all",path="/apis/apps/v1/namespaces/{namespace}/controllerrevisions",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("patch",path="/apis/apps/v1/namespaces/{namespace}/controllerrevisions/{name}",response="static::class")
