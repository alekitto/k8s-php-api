...
namespace K8s\Api\Model\Api\Scheduling\v1beta1;
 ...
 *
 * @Kubernetes\Kind("PriorityClass",group="scheduling.k8s.io",version="v1beta1")
 * @Kubernetes\Operation("get",path="/apis/scheduling.k8s.io/v1beta1/priorityclasses/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/scheduling.k8s.io/v1beta1/priorityclasses",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/scheduling.k8s.io/v1beta1/priorityclasses/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("put",path="/apis/scheduling.k8s.io/v1beta1/priorityclasses/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection-all",path="/apis/scheduling.k8s.io/v1beta1/priorityclasses",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/scheduling.k8s.io/v1beta1/priorityclasses",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/scheduling.k8s.io/v1beta1/priorityclasses/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("list-all",path="/apis/scheduling.k8s.io/v1beta1/priorityclasses",response="K8s\Api\Model\Api\Scheduling\v1beta1\PriorityClassList")
 */
class PriorityClass
{
    /**
     ...
     * @var string|null
     */
    protected $apiVersion = 'scheduling.k8s.io/v1beta1';
