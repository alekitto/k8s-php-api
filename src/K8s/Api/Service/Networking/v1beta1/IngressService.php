...
class IngressService
{
     ...
     */
    public function patchNetworkingV1beta1Namespaced(string $name, array $patch, array $query = []): Ingress
    {
        $options['query'] = $query;
        $options['body'] = $patch;
        $options['model'] = Ingress::class;
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.20/#patch-ingress-v1beta1-networking-k8s-io
     */
    public function patchNetworkingV1beta1NamespacedStatus(string $name, array $patch, array $query = []): Ingress
    {
        $options['query'] = $query;
        $options['body'] = $patch;
        $options['model'] = Ingress::class;
