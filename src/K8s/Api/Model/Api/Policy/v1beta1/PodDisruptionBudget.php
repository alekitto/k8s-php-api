 ...
 * @Kubernetes\Operation("delete",path="/apis/policy/v1beta1/namespaces/{namespace}/poddisruptionbudgets/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
