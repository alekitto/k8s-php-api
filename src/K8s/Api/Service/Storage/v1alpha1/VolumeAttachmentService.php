...
class VolumeAttachmentService
{
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#list-volumeattachment-v1alpha1-storage-k8s-io
     */
     ...
     * @param array $query
     * @param callable|null $handler
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#delete-collection-volumeattachment-v1alpha1-storage-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#create-volumeattachment-v1alpha1-storage-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#read-volumeattachment-v1alpha1-storage-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#delete-volumeattachment-v1alpha1-storage-k8s-io
     */
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#patch-volumeattachment-v1alpha1-storage-k8s-io
     */
    public function patchStorageV1alpha1(string $name, array $patch, array $query = []): VolumeAttachment
    {
        $options['query'] = $query;
        $options['body'] = $patch;
        $options['model'] = VolumeAttachment::class;
     ...
     *
     * @param array $query
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#put-volumeattachment-v1alpha1-storage-k8s-io
     */
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#watchlist-volumeattachment-v1alpha1-storage-k8s-io
     */
     ...
     * @link https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#watch-volumeattachment-v1alpha1-storage-k8s-io
     */
