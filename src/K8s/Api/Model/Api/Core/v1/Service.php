 ...
 * @Kubernetes\Operation("deletecollection-all",path="/api/v1/namespaces/{namespace}/services",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("patch",path="/api/v1/namespaces/{namespace}/services/{name}",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/api/v1/namespaces/{namespace}/services/{name}/status",response="static::class")
...
class Service
{
     ...
     * @return static
     */
    public function setTrafficDistribution(string $trafficDistribution)
    {
