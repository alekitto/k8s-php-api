 ...
 *
 * @Kubernetes\Kind("PodScheduling",group="resource.k8s.io",version="v1alpha1")
 * @Kubernetes\Operation("get",path="/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/podschedulings/{name}",response="static::class")
 * @Kubernetes\Operation("get-status",path="/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/podschedulings/{name}/status",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/podschedulings",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/podschedulings/{name}",response="static::class")
 * @Kubernetes\Operation("watch",path="/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/podschedulings",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("put",path="/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/podschedulings/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("put-status",path="/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/podschedulings/{name}/status",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection",path="/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/podschedulings",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/resource.k8s.io/v1alpha1/podschedulings",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/podschedulings/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/podschedulings/{name}/status",body="patch",response="static::class")
 * @Kubernetes\Operation("list",path="/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/podschedulings",response="K8s\Api\Model\Api\Resource\v1alpha1\PodSchedulingList")
 * @Kubernetes\Operation("list-all",path="/apis/resource.k8s.io/v1alpha1/podschedulings",response="K8s\Api\Model\Api\Resource\v1alpha1\PodSchedulingList")
 */
class PodScheduling
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("spec",type="model",model=PodSchedulingSpec::class,isRequired=true)
     * @var PodSchedulingSpec
     */
    protected $spec;

    /**
     * @Kubernetes\Attribute("status",type="model",model=PodSchedulingStatus::class)
     * @var PodSchedulingStatus|null
     */
    protected $status = null;

    /**
     * @param PodSchedulingSpec $spec
     */
    public function __construct(?string $name, PodSchedulingSpec $spec)
    {
     ...
     */
    public function getSpec(): PodSchedulingSpec
    {
        return $this->spec;
    }
     ...
     * @return static
     */
    public function setSpec(PodSchedulingSpec $spec)
    {
        $this->spec = $spec;
     ...
     */
    public function getStatus(): ?PodSchedulingStatus
    {
        return $this->status;
    }
     ...
     * @return static
     */
    public function setStatus(PodSchedulingStatus $status)
    {
        $this->status = $status;
